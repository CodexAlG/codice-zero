...
const AgentCard = memo(({ agent, priority = false }) => {
  ...
  const rankBottomColor = agent.rank === 'S' ? 'border-b-yellow-500' : agent.rank === 'A' ? 'border-b-purple-500' : 'border-b-blue-500';
  const hoverGlow = agent.rank === 'S' ? 'hover:shadow-[0_0_20px_rgba(234,179,8,0.5)]' : agent.rank === 'A' ? 'hover:shadow-[0_0_20px_rgba(168,85,247,0.5)]' : 'hover:shadow-[0_0_20px_rgba(59,130,246,0.5)]';
