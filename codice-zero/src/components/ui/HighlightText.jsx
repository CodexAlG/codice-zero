...
const createHighlightRules = (elementColor = "#facc15") => [
  ...
  // Físico
  { pattern: /(Asalto\s+de\s+Polaridad|Hoja\s+Afilada|Honed\s+Edge|Acumulaci[oó]n\s+de\s+Anomal[ií]a\s+F[ií]sica|Daño\s+F[ií]sico(?:\s+Puro)?|Anomal[ií]a\s+F[ií]sica|Res\s+F[ií]sic[oa]|Resistencia\s+F[ií]sica|Asalto|F[ií]sico|F[ií]sica(?:\s+Pura)?|Anomal[ií]a\s+de\s+Atributo\s+(?:de\s+)?F[ií]sic[oa]|Physical Damage|Physical Anomaly|Physical Resistance|Assault|Physical Attribute Anomaly|Physical Anomaly Buildup|\bPhysical\b)/gi, color: "text-[#eab308] font-bold" },
  // Etéreo
  ...
  // Viento
  { pattern: /(Acumulaci[oó]n\s+de\s+Anomal[ií]a\s+Viento|Daño\s+Viento(?:\s+Puro)?|Anomal[ií]a\s+Viento|Res\s+Viento|Resistencia\s+Viento|Viento(?:\s+Puro)?|Anomal[ií]a\s+de\s+Atributo\s+(?:de\s+)?Viento|Wind Damage|Wind Anomaly|Wind Resistance|Wind Attribute Anomaly|Wind Anomaly Buildup|Corrosi[oó]n|\bWind\b)/gi, color: "text-[#38bdf8] font-bold" },
