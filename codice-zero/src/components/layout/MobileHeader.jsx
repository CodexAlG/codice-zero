  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-16 bg-gray-950/95 backdrop-blur-md border-b border-white/10 flex items-center justify-between px-4 lg:hidden">
      ...
      <Link href="/" className="flex-shrink-0">
        <div className="text-xl font-display font-black italic text-transparent bg-clip-text bg-gradient-to-br from-yellow-300 to-yellow-600 tracking-tighter drop-shadow-[0_0_10px_rgba(234,179,8,0.9)]">
          CZ
        </div>
      </Link>
