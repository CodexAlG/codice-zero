...
export default {
    ...
    skills: [
        ...
        },
        {
            ...
            description: "Cuando Sunna está fuera del campo en combate y no hay enemigos con la marca [Hipnotizado] en el campo, Kitty consumirá 1 [Punto de Ataque] de Sunna y lanzará automáticamente un ataque, infligiendo Daño Físico. Cuando cualquier miembro del escuadrón activa o extiende cualquier [Velo Etéreo], Sunna gana 3 [Puntos de Ataque].",
            tags: ["Físico", "Ataque Básico", "Fuera del Campo"]
        },
        {
            type: "Evasión",
            name: "Evasión: Volar",
            description: "Presiona [Icono Evasión] para activar: Una evasión rápida de dash. El personaje es invulnerable mientras usa esta habilidad.",
            tags: ["Evasión"]
        },
        {
            type: "Evasión",
        ...
        },
        {
            ...
            description: "Con suficiente Energía, presiona [Icono Especial] para activar: Lanza un gato para golpear al objetivo e infligir Daño Físico. Después de activar esta habilidad, si no hay gatos en el campo, invoca un gato. Al activar esta habilidad, aplica el efecto [Fiebre] a todos los Agentes en el escuadrón durante 40s. Cuando el ataque pesado de la habilidad golpea a un enemigo, activa [Asistencia Rápida]. El personaje es invulnerable mientras usa esta habilidad.",
            tags: ["Físico", "Técnica Especial EX"]
        },
        {
            type: "Técnica Especial EX",
            name: "Ataque Especial EX: Ataque de Enlace de Cámara",
            description: "Después de entrar en [Fiebre], presiona [Icono Especial] para activar: Golpea a los enemigos objetivo junto con Kitty, infligiendo Daño Físico. Después de usar esta habilidad, si no hay gato en el campo, invoca a Kitty. Cuando se activa el ataque pesado, abre [Velo Etéreo: Ídolo]. Mientras [Velo Etéreo: Ídolo] está activo, incrementa el ATK de todos los miembros del escuadrón en 50 puntos adicionales durante 30s. Antes de que Sunna reabra [Velo Etéreo: Ídolo], el [Velo Etéreo: Ídolo] existente se cerrará. Cuando el ataque pesado de la habilidad golpea a un enemigo, activa [Asistencia Rápida]. El personaje es invulnerable mientras usa esta habilidad. Cada vez que se entra en [Fiebre], [Ataque Especial EX: Golpe Combinado Fotográfico] solo puede activarse una vez.",
            tags: ["Físico", "Técnica Especial EX", "Velo Etéreo"]
        },
        {
        ...
        },
        {
            ...
            description: "Cuando la Calificación de Decibelios está al Máximo, presiona [Icono Definitiva] para activar: Juega a golpea al topo con el gato mientras ataca a los enemigos, causando Daño Físico masivo. Cuando se activa un ataque pesado, se habilita [Velo Etéreo: Ídolo]. Cuando un ataque pesado de habilidad golpea a un enemigo, activa [Asistencia Rápida]. El personaje es invulnerable mientras usa esta habilidad.",
            tags: ["Físico", "Técnica Definitiva"]
        },
        {
            type: "Asistencia",
            name: "Asistencia Rápida: Triple Gancho",
            description: "Cuando el personaje activo es lanzado, presiona [Icono Asistencia] para activar: Golpea a los enemigos en frente con golpes de martillo consecutivos, infligiendo Daño Físico. El personaje es invulnerable mientras usa esta habilidad.",
            tags: ["Físico", "Asistencia"]
        },
        {
            type: "Asistencia",
            name: "Asistencia Defensiva: Bloqueo",
            description: "Cuando el personaje en el campo está a punto de ser atacado, presiona [Icono Asistencia] para activar: Parry al ataque del enemigo, causando Aturdimiento masivo. El personaje es invulnerable mientras usa esta habilidad.",
        ...
        },
        {
            ...
            description: "Los personajes en el estado [Fiebre] ganan ATK aumentado igual al (210%) del ATK inicial de Sunna, hasta un máximo de (2100). [Ataque Básico: Arañazo de Pata], [Ataque Especial EX: Golpe de Gato], [Ataque Especial EX: Ataque de Enlace de Cámara], [Ataque en Cadena: Embestida Gatuna] y [Definitiva: Golpea al Topo] aplican la marca [Hipnotizado] a los objetivos al golpear, durando 12 segundos. Mientras Sunna está en el campo, la duración de la marca [Hipnotizado] se refresca continuamente; los enemigos normales con la marca [Hipnotizado] tienen aggro reducido hacia Sunna. Cuando personajes de [Ataque] o [Anomalía] en el escuadrón atacan continuamente y aciertan un ataque pesado en enemigos con la marca [Hipnotizado], activan y detonan la marca [Hipnotizado]. Cuando un personaje de [Ataque] la detona, infligen Daño de Atributo igual al (210%) del ATK a los enemigos en rango. Cuando un personaje de [Anomalía] la detona, infligen Daño de Atributo igual al (210%) del ATK a los enemigos en rango. Este DAÑO está garantizado de ser CRÍTICO y el Daño CRIT aumenta en un (100%). Cuando múltiples enemigos con la marca [Hipnotizado] están en el campo, solo la marca [Hipnotizado] del objetivo principal de ataque será activada, y otras marcas [Hipnotizado] serán eliminadas. Cuando un enemigo está Aturdido, la marca [Hipnotizado] se activa más rápidamente.",
            tags: ["Pasiva Central", "Físico"]
        },
        {
            type: "Habilidad Adicional",
            name: "Habilidad Adicional: Sunna",
            description: "Cuando otro personaje en tu escuadrón es un Personaje de [Ataque] o [Anomalía]: \nCuando un personaje dentro de [Velo Etéreo: Ídolo] golpea a un enemigo con un ataque, el Multiplicador de Daño de Aturdimiento del objetivo aumenta en un 30% por 40s. \nCuando otro personaje en tu escuadrón es un Personaje de [Ataque], mientras [Velo Etéreo: Ídolo] está activo, el Daño CRIT de todos los miembros del escuadrón aumenta en un 15%. \nCuando otro personaje en tu escuadrón es un Personaje de [Anomalía], mientras [Velo Etéreo: Ídolo] está activo, la Maestría de Anomalía de todos los miembros del escuadrón aumenta en 30.",
        ...
        },
        {
            ...
            description: "Mientras Sunna está dentro de cualquier [Velo Etéreo], gana 1 [Punto de Ataque] cada 10s; cuando la marca [Hipnotizado] es activada, su DAÑO ignora el 15% de la RES de Atributo del objetivo.",
            tags: ["Mindscape"]
        },
        {
            type: "Mindscape 3",
