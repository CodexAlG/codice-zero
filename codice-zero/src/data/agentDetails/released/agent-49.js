...
export default {
    ...
    coreSkillScaling: [
        ["150%", "240%", "80%", "525", "2950"],
        ["175%", "280%", "90%", "615", "2950"],
        ["200%", "320%", "100%", "705", "2950"],
        ["225%", "360%", "120%", "795", "2950"],
        ["250%", "400%", "130%", "885", "2950"],
        ["275%", "440%", "140%", "975", "2950"],
        ["300%", "480%", "150%", "1050", "2950"],
    ],
    skills: [
        {
            type: "Ataque Básico",
        ...
        },
        {
            ...
            description: "Cuando Sunna está fuera del campo en combate y no hay enemigos con la marca (Mirada de Gato) en el campo, Bubble Pop consumirá 1 (Pulidor de Uñas) y lanzará automáticamente un ataque, infligiendo Daño Físico. Cuando cualquier miembro del escuadrón activa o extiende cualquier (Velo Etereo), Sunna gana 2 (Pulidores de Uñas). Cuando cualquier personaje del equipo aplica un efecto de Anomalia de atributo obtiene, Sunna obtiene 1 (Pulidor de Uñas), se activa como máximo 1 vez cada 10 segundos; Bubble Pop puede heredar el Ataque inicial de Sunna. Sunna puede tener un máximo de 6 (Pulidores de Uñas).",
            tags: ["Físico", "Ataque Básico"]
        },
        {
            type: "Evasión",
        ...
        },
        {
            ...
            name: "Técnica Especial: Lanzamiento Estelar",
            description: "Presiona [Icono Especial] para activar: Dispara Bubble Pop desde la pistola de aire para atacar enemigos adelante, infligiendo Daño Físico. Después de activar esta habilidad, (Bubble Pop se une) al combate.",
            tags: ["Físico", "Técnica Especial"]
        },
        {
            type: "Técnica Especial EX",
            name: "Técnica Especial EX: Bomba de Chicle",
            description: "Con suficiente Energía, presiona [Icono Especial EX] para activar: Lanza a Bubble Pop, golpeando al objetivo e inflige Daño Físico. Después de activar esta habilidad, (Bubble Pop se une) al combate. Cuando se activa la habilidad, aplica el efecto (Acorde de Ángel) a todos los Agentes en el escuadrón por 40s. Cuando el ataque pesado de la habilidad golpea a un enemigo, activa (Asistencia Rápida). El personaje es invulnerable mientras usa esta habilidad.",
            tags: ["Físico", "Técnica Especial EX"]
        },
        {
            type: "Técnica Especial EX",
            name: "Técnica Especial EX: Técnica de Cámara Especial",
            description: "Después de entrar en (Acorde de Ángel), presiona [Icono Especial EX] para activa, mantén presionado [Icono Especial EX] para activar rapidamente: Lanza un Ataque Coordinado con Bubble Pop contra enemigos objetivo, infligiendo Daño Físico. Después de usar esta habilidad, (Bubble Pop se une) al combate. Antes de que se active la habilidad, abre (Velo Etereo: Encore Fantasía). Mientras (Velo Etereo: Encore Fantasía) está activo, incrementa el ATK de todos los miembros del escuadrón en 50 puntos adicionales durante 40s. Antes de que Sunna reabra (Velo Etereo: Encore Fantasía), el (Velo Etereo: Encore Fantasía) existente se cerrará. Cuando el ataque pesado de la habilidad golpea a un enemigo, activa (Asistencia Rápida). El personaje es invulnerable mientras usa esta habilidad. Cada vez que (Acorde de Ángel) es activado, (Técnica Especial EX: Técnica de Cámara Especial) solo puede activarse una vez.",
        ...
        },
        {
            ...
            description: "Los personajes en el estado (Acorde de Ángel) incrementan su ATK en una cantidad igual al 30% del ATK inicial de Sunna; cuando el ATK inicial alcanza {VALOR_4} puntos, todo el equipo recibe un aumento de ATK de hasta un máximo de 3500 puntos, el efecto de aumento de Ataque proporcionado a los personajes del equipo alcanza su valor maximo. Cuando (Ataque Basico: Gatita Mala al Acecho), (Técnica Especial EX: Bomba de Chicle), (Técnica Especial EX: Tecnica de Camara Especial), (Ataque en Cadena), (Definitiva) golpean a un enemigo, aplican (Mirada de Gato) al objetivo durante 12s. Mientras Sunna está en el campo, la duración de (Mirada de Gato) se refresca continuamente; los enemigos normales con (Mirada de Gato) tienen un deseo de ataque reducido hacia Sunna. Cuando personajes de (Ataque) o (Anomalía) en el equipo atacan continuamente a un enemigo con (Mirada de Gato), se activa y elimina (Mirada de Gato): Cuando es activado por un personaje de (Atacante), inflige un {VALOR_1} del ATQ como Daño de Atributo del Agente a los enemigos en el rango. Cuando es activado por un personaje de (Anomalía), inflige un {VALOR_2} del ATQ como Daño de Atributo del Agente a los enemigos en el rango; este daño es Crítico garantizado, y el Daño Crítico aumenta en un {VALOR_3}. El daño causado por (Mirada de Gato) se considera daño causado por el (Agente Activador). Cuando hay múltiples enemigos con (Mirada de Gato) en el campo, solo se activará la (Mirada de Gato) del objetivo principal, y al activarse se removerán todas las (Mirada de Gato) del campo; la cantidad de ataques requeridos para la activación de (Mirada de Gato) se reduce enormemente. Cuando un enemigo está en estado de Aturdimiento, (Mirada de Gato) se activará más rápidamente.",
            tags: ["Pasiva Central"]
        },
        {
            type: "Habilidad Adicional",
            name: "Habilidad Adicional: Contrapunto del Ensueño",
            description: "Se activa cuando hay un personaje de (Ataque) o de la misma Facción en el equipo:\\nCuando un personaje dentro del (Velo Etereo: Encore Fantasía) golpea a un enemigo, el Multiplicador de Daño de Aturdimiento del objetivo aumenta en un 30% durante 40s.\\nAl entrar al campo de batalla, recupera 15 de Energía. En modo Cavidad Cero, el efecto puede activarse una vez cada 180s y solo se activa una vez.",
