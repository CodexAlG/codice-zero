...
export default {
  ...
  skills: [
    ...
    },
    {
      ...
      description: "Mientras está en el estado (Filo Fundido), presiona [Icono Ataque] para activar: Desata hasta cuatro cortes hacia adelante, causando Daño Fuego. Si los PV de Manato están por encima del 30% cuando la habilidad es activada, se consumirá un 3.5% de sus PV Máx.",
      tags: ["Fuego", "Ataque Básico"]
    },
    {
      type: "Evasión",
    ...
    },
    {
      ...
      description: "Siempre que Manato pierde PV, la cantidad de PV perdidos es contada. Cada 1% de sus PV Máx contados aumenta el Daño Fuego de (Ataques de Asistencia) y (Ataques Basicos) en un 0.4%, hasta un máximo de 20%.",
      tags: ["Mindscape 1"]
    },
    {
      type: "Mindscape 2",
    ...
    },
    {
      ...
      description: "PV Máx aumenta un 8%. Durante (Tecnica Especial: Retorno a las Cenizas) y (Tecnica Especial: Retorno a las Cenizas - Sacrificio), cuando Manato recibe DAÑO fatal, permanece en batalla, con sus PV no bajando de 1. Este efecto puede activarse una vez cada 10s.",
      tags: ["Mindscape 4"]
    },
    {
      type: "Mindscape 5",
