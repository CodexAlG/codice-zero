...
export default {
    ...
    skills: [
        ...
        },
        {
            ...
            description: "Mantén presionado [Icono Ataque] para activar: Aria entra en estado de carga, se puede cargar hasta dos niveles. Al soltar [Icono Ataque] o alcanzar el tiempo máximo de carga, Aria lanzará un poderoso ataque descendente hacia adelante basado en el nivel de carga actual, infligiendo gran cantidad de Daño Etéreo; Si Aria está cargando y hay (Energía de Apoyo) cerca, absorberá la (Energía de Apoyo). Cada vez que absorba con éxito 1 (Energía de Apoyo), aumentará inmediatamente el nivel de carga en 1 y obtendrá 1 efecto de mejora: El Aturdimiento y el Daño infligidos por el siguiente (Ataque Básico: Tono Absoluto) aumentan un 10%. Este efecto de mejora se puede acumular hasta 2 veces y se elimina tras finalizar el ataque; Tras el cuarto golpe de (Ataque Básico: Ritmo Dulce), (Técnica Especial: Sonido Electrónico Sin Hielo), (Técnica Especial EX), el tercer golpe de (Ataque Básico: Tono Absoluto), (Asistencia Rápida), (Ataque en Cadena) o (Técnica Definitiva), si la cantidad de (Energía de Apoyo) cercana es mayor o igual a 2, se puede mantener presionado [Icono Ataque] consumiendo 2 (Energía de Apoyo) para activar rápidamente la tercera fase de (Ataque Básico: Tono Absoluto); tras el tercer golpe de (Ataque Básico: Tono Absoluto), (Ataque en Cadena) o (Técnica Definitiva), si la cantidad de (Energía de Apoyo) cercana es mayor o igual a 2, también se puede presionar [Icono Ataque] dentro de un periodo de tiempo consumiendo 2 (Energía de Apoyo) para activar rápidamente la tercera fase de (Ataque Básico: Tono Absoluto); Durante el periodo de carga, el nivel de resistencia a la interrupción aumenta, el daño recibido se reduce en un 40% y se posee efecto de invencibilidad durante la ejecución del ataque.",
            tags: ["Etéreo", "Ataque Básico"]
        },
        {
            type: "Evasión",
            name: "Evasión: Ritmo Preciso",
            description: "Presiona [Icono Dodges] para activar: Realiza una evasión rápida con desplazamiento; Si se activa durante (Ataque Básico: Ritmo Dulce), no se reiniciarán los golpes del Ataque Básico durante esta acción; Posee efecto de invencibilidad durante la activación de la habilidad.",
            tags: ["Evasión"]
        },
        {
            type: "Evasión",
            name: "Ataque de Carrera: Pequeño Combo Sedoso",
            description: "Al evadir, presiona [Icono Ataque] para activar: Se lanza hacia adelante realizando cortes rápidos, infligiendo Daño Etéreo; Si se activa durante (Ataque Básico: Ritmo Dulce), no se reiniciarán los golpes del Ataque Básico durante esta acción.",
            tags: ["Etéreo", "Evasión"]
        },
        {
            type: "Evasión",
            name: "Contraataque de Evasión: Variación Dinamica",
            description: "Tras activar una (Evasión Perfecta), presiona [Icono Ataque] para activar: Lanza un poderoso corte al objetivo, infligiendo Daño Etéreo; Tras activar la habilidad, se puede conectar directamente con el tercer golpe de (Ataque Básico: Ritmo Dulce); Posee efecto de invencibilidad durante la activación de la habilidad.",
            tags: ["Etéreo", "Evasión"]
        },
        {
        ...
        },
        {
            ...
            description: "Tras el cuarto golpe de (Ataque Básico: Ritmo Dulce), (Ataque de Asistencia), (Ataque en Cadena) o (Técnica Definitiva), presiona [Icono Especial] para activar: Lanza una patada aún más veloz hacia adelante, infligiendo Daño Etéreo. Si el ataque acierta al enemigo, generará 1 (Energía de Apoyo) en el campo al finalizar el ataque; Posee efecto de invencibilidad durante la activación de la habilidad.",
            tags: ["Etéreo", "Técnica Especial"]
        },
        {
