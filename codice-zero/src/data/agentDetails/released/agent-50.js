export default {
    ...
    skills: [
        ...
        },
        {
            ...
            description: "Cada capa de (Vibrato) hace que la proporción de daño de (Abloom) en la (Pasiva Central: Ídolo Genio) aumente adicionalmente en un 10%; el multiplicador de daño de vulnerabilidad por aturdimiento proporcionado por la (Habilidad Adicional: Capitana Ángel) aumenta adicionalmente en un 30%; cuando la (Ataque en Cadena) del personaje en uso golpea a un enemigo que se encuentra bajo un estado de Anomalía de Atributo y Aturdimiento, activará (Desorden de Polaridad) en el enemigo, infligiendo al objetivo un 25% del daño del efecto de (Desorden) original, el enemigo puede activar este efecto como máximo una vez durante el mismo periodo de Aturdimiento.."
        },
        {
            type: "Mindscape 3",
        ...
        },
        {
            ...
            description: "El multiplicador de daño de vulnerabilidad por aturdimiento causado por los ataques de Nangong Yu aumenta en un 50%; cuando el enemigo no se encuentra en estado de Aturdimiento, cada vez que recibe un ataque de (Abloom) o (Desorden) por parte de cualquier personaje, y al ser golpeado por el golpe pesado de la (Técnica Especial EX: Afecto Bastante Pesado) o del (Ataque Cargado: Lindo Choque Volador de Mina Terrestre), acumulará 1 capa de (Vibrato: Modificado), al ser golpeado por el golpe pesado de la (Técnica Definitiva: Cúmulo Estelar Errante) acumulará 2 capas de (Vibrato: Modificado); (Vibrato: Modificado) se puede acumular hasta un máximo de 4 capas, cuando el enemigo entra en estado de Aturdimiento, (Vibrato: Modificado) será eliminado por completo, cuando (Vibrato: Modificado) es eliminado, si el enemigo se encuentra bajo un estado de Anomalía de Atributo Etéreo, Anomalía de Atributo Eléctrico, Anomalía de Atributo Fuego, Anomalía de Atributo Físico o Anomalía de Atributo Hielo, Nangong Yu infligirá un ataque de (Abloom) al objetivo: calculando adicionalmente un daño de Anomalía de Atributo una vez, la proporción relativa al daño de Anomalía de Atributo original es 800%/400%/1000%/70%/100%, por cada 1 capa de (Vibrato: Modificado) que tenga el enemigo, la proporción de daño de esta (Abloom) aumenta adicionalmente en un 25%; (Vibrato: Modificado) y (Vibrato) no se pueden superponer entre sí.",
