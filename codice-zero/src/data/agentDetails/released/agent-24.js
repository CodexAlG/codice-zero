...
export default {
  ...
  skills: [
    ...
    },
    {
      type: "Mindscape 6",
      name: "Sobreviviente",
      description: "La eficiencia de recuperación de (Moral) de Lighter aumenta al 200% de su valor original. Cuando Lighter asesta un golpe pesado en enemigos durante un (Ataque Básico), (Contraataque de Evasión), (Técnica Especial), (Técnica Especial EX), (Asistencia Rápida), (Ataque de Asistencia), (Ataque en Cadena), o (Definitiva), activará el efecto (Impacto Abrasador), causando 250% del ATK como Daño Fuego. Este efecto puede activarse una vez cada 8s en cada enemigo. Si el Impacto de Lighter excede 170 puntos, cada punto adicional aumentará aún más el multiplicador de (Impacto Abrasador) en un 5%, hasta un aumento máximo del 500%. El Movimiento Final más poderoso que sigue cuando la (Moral) de Lighter es completamente agotada durante un golpe ligero o combo de jab activará una activación adicional de (Impacto Abrasador) al golpear un enemigo, ignorando el enfriamiento del efecto.",
      tags: ["Mindscape 6"]
    }
  ]
};
