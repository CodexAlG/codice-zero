...
export default {
  ...
  potential: {
    ...
    description: "La (Habilidad Adicional: Tormenta Creciente) de Ellen aumenta el Daño Crítico en un {VALOR_1} por acumulación. A las 10 acumulaciones, el ataque ignora el {VALOR_2} de la resistencia a Hielo del objetivo."
  },
  skills: [
    {
      type: "Ataque Básico",
    ...
    },
    {
      ...
      description: "Mientras estás en el estado (Deambular), presiona [Icono Ataque] para activar: Lanza un ataque giratorio a enemigos antes de abrir sus tijeras para un golpe de Tijera Veloz, infligiendo Daño de Hielo. Gana 1 punto de (Carga de Congelación Relámpago) cuando el golpe de Tijera Veloz golpea. \nMientras estás en el estado (Deambular), mantén [Icono Ataque] para activar: Realiza un ataque giratorio contra el enemigo, luego separa las tijeras para desatar un golpe de Tijera Cargado, infligiendo Daño de Hielo masivo. Gana 3 puntos de (Carga de Congelación Relámpago) cuando el golpe de Tijera Cargado golpea. Si el enemigo es Congelado, siempre activa (Rompehielo). El nivel de Anti-Interrupción aumenta mientras se carga la habilidad, y el daño recibido se reduce en un 40%. Al recibir Daño de enemigos mientras la habilidad se está cargando, esa instancia de Daño se anula, y la carga se completa instantáneamente. El personaje es invulnerable mientras usa esta habilidad.",
    ...
    },
    {
      ...
      description: "Mientras (Congelación Relámpago) está activa, presiona [Icono Ataque] durante una evasión para activar: Lanza un ataque de corte deslizante a enemigos en frente, infligiendo Daño de Hielo. Consume 1 (Carga de Congelación Relámpago).",
      tags: ["Hielo", "Ataque de Carrera"]
    },
    {
      type: "Evasión",
      name: "Contraataque de Evasión: Arrecife",
      description: "Presiona [Icono Ataque] durante una (Evasión Perfecta) para activar: Se mueve rápidamente a través de enemigos con las tijeras abiertas para un golpe cortante, infligiendo Daño de Hielo. El personaje es invulnerable mientras usa esta habilidad.",
      tags: ["Hielo", "Contraataque de Evasión"]
    },
    {
      type: "Técnica Especial",
      name: "Técnica Especial: Derrape",
      description: "Presiona [Icono Especial] para activar: Usa un ataque rápido de barrido de cola en frente, infligiendo Daño de Hielo. El nivel de Anti-Interrupción aumenta mientras se usa esta habilidad.",
      tags: ["Hielo", "Técnica Especial"]
    },
    {
      type: "Técnica Especial",
      name: "Técnica Especial EX: Golpe de Cola",
      description: "Con suficiente energía, presiona [Icono Especial] para activar: Realiza un poderoso ataque de látigo con la cola que inflige Daño de Hielo masivo. Gana 1 (Carga de Congelación Relámpago) al golpear a un enemigo. El personaje es invulnerable mientras usa esta habilidad. Después de ejecutar el movimiento, puedes seguir inmediatamente con el 3er golpe de un (Ataque Básico).",
      tags: ["Hielo", "Técnica Especial EX"]
    },
    {
      type: "Técnica Especial",
      name: "Técnica Especial EX: Tiburonami",
      description: "Con suficiente Energía y después de ejecutar (Técnica Especial EX: Golpe de Cola), presiona [Icono Especial] para activar: Realiza una poderosa serie de cortes hacia adelante que infligen Daño de Hielo masivo. Gana 1 (Carga de Congelación Relámpago) al golpear a un enemigo. El personaje es invulnerable mientras usa esta habilidad. Después de ejecutar el movimiento, puedes seguir inmediatamente con el 3er golpe de un (Ataque Básico).",
      tags: ["Hielo", "Técnica Especial EX"]
    },
    {
      type: "Técnica Definitiva",
      name: "Técnica en Cadena: Avalancha",
      description: "Cuando se activa un (Ataque en Cadena), selecciona al personaje para activar: Cae desde arriba y desata una tormenta de hielo, infligiendo Daño de Hielo masivo. El personaje es invulnerable mientras usa esta habilidad.",
      tags: ["Hielo", "Técnica en Cadena"]
    },
    {
      type: "Técnica Definitiva",
      name: "Definitiva: Invierno Eterno",
      description: "Cuando el Índice de Decibelios está al Máximo, presiona [Icono Definitiva] para activar: Cae desde arriba y desata una tormenta de hielo antes de un poderoso golpe de tijera, infligiendo Daño de Hielo masivo. El personaje es invulnerable mientras usa esta habilidad.",
    ...
    },
    {
      ...
      description: "Presiona [Icono Ataque] después de una (Asistencia Defensiva) para activar: Carga y corta a enemigos en frente, infligiendo Daño de Hielo. Presiona repetidamente o mantén presionado [Icono Ataque] durante el ataque para extender la duración de la habilidad. El personaje es invulnerable mientras usa esta habilidad.",
