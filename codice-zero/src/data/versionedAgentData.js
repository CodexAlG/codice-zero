                ...
                skills: [
                    {
                        type: "Ataque Básico",
                        name: "Ataque Básico: Ritmo Dulce",
                        description: "Presiona [Icono Ataque] para activar: Ejecuta hasta 4 ataques consecutivos hacia adelante, causando Daño Etéreo. Si el 4to ataque golpea a un enemigo, en el campo se genera 1 (Energía de Soporte) después de completar el ataque.",
                        tags: ["Etéreo", "Ataque Básico"]
                    },
                    {
                        type: "Ataque Básico",
                        name: "Ataque de Carga: Tono Absoluto",
                        description: "Mantén [Icono Ataque] para activar: Aria entra en estado de carga, pudiendo cargar hasta 3 niveles. Cuando [Icono Ataque] es soltado o el tiempo máximo de carga es alcanzado, desata un poderoso ataque descendente hacia adelante basado en el nivel de carga, causando masivo Daño Etéreo. Si hay (Energía de Soporte) cerca de Aria mientras carga, ella absorberá la (Energía de Soporte). Cada (Energía de Soporte) absorbida exitosamente incrementa el nivel de carga por 1 y obtiene 1 acumulación de incremento de efecto: la Acumulación de Anomalía del siguiente Ataque de Carga aumenta un 10%. La Acumulación de Anomalía se acumula hasta 2 veces, y el efecto se remueve después de que el Ataque de Carga termina. Después del 4to golpe de (Ataque Básico: Ritmo Dulce), (Técnica Especial: Electro-Pop Dulce: Refuerzo), el 3er golpe de (Ataque Básico: Ritmo Dulce), (Ataque en Cadena), (Definitiva), o un Nivel 3 (Ataque de Carga: Tono Absoluto), si hay más de 2 (Energía de Soporte) cerca, sosteniendo [Icono Ataque] puede lanzar directamente un Lanzamiento Rápido de Nivel 3 (Ataque de Carga: Tono Absoluto); Mientras carga, el Nivel Anti-Interrupción de Aria aumenta y el DAÑO recibido se reduce en un 40%. El ataque tiene efecto de invencibilidad después de que termina.",
                        tags: ["Etéreo", "Ataque Básico"]
                    },
                    {
                        type: "Evasión",
                    ...
                    },
                    {
                        type: "Evasión",
                        name: "Contraataque de Evasión: Variación Deslizante",
                        description: "Presiona [Icono Ataque] durante una (Evasión Perfecta) para activar: Ejecuta un poderoso golpe en el objetivo, causando Daño Etéreo. Después de activar esta habilidad, puede conectar directamente con el 3er golpe de (Ataque Básico: Ritmo Dulce). El personaje es invulnerable mientras usa esta habilidad.",
                        tags: ["Etéreo", "Evasión"]
                    },
                    {
                        type: "Técnica Especial",
                    ...
                    {
                        type: "Técnica Especial",
                        name: "Técnica Especial: Electro-Pop Dulce: Refuerzo",
                        description: "Después del 4to golpe de (Ataque Básico: Ritmo Dulce), (Asistencia de Seguimiento), (Ataque en Cadena), y (Definitiva), presiona [Icono Especial] para activar: Lanza una patada más rápida hacia adelante, causando Daño Etéreo. Si el ataque golpea a un enemigo, 1 (Energía de Soporte) será generada en el campo después de que el ataque completa. El personaje tiene efecto de invencibilidad mientras usa esta habilidad.",
                        tags: ["Etéreo", "Técnica Especial"]
                    },
                    {
                        type: "Técnica Especial EX",
                    ...
                    },
                    {
                        type: "Técnica Definitiva",
                        name: "Ataque en Cadena: Colaboración Soñada",
                        description: "Cuando un (Ataque en Cadena) es activado, selecciona el personaje para activar: Desata ataques consecutivos hacia adelante, causando masivo Daño Etéreo. Cuando la habilidad se activa, en el campo se generan 4 (Energía de Soporte). El personaje es invulnerable mientras usa esta habilidad.",
                        tags: ["Etéreo", "Ataque en Cadena"]
                    },
                    {
                        type: "Técnica Definitiva",
                        name: "Definitiva: Vitalidad al Máximo",
                        description: "Cuando el Nivel de Decibelios está al (Máximo), presiona [Icono Definitiva] para activar: Desata su poder completo entrando en (Momento de Fantasía) y disparando múltiples disparos poderosos en el objetivo, causando masivo Daño Etéreo. Cuando entra en (Momento de Fantasía), Aria gana 3 capas de (Apoyo Total), mientras activa (Velo Etereo: Fantasía Bis). Mientras (Velo Etereo: Fantasía Bis) está activo, todos los miembros del escuadrón ganan 50 de ATK adicional por 30s. Antes de que Aria activa (Velo Etereo: Fantasía Bis) de nuevo, cualquier (Velo Etereo: Fantasía Bis) existente será desactivado; Cuando Aria carga, si ella tiene el efecto (Apoyo Total), ella priorizará consumir 1 capa de (Apoyo Total) y convertirla en (Energía de Soporte). Cada capa de (Apoyo Total) puede convertirse en 2 (Energía de Soporte); En (Momento de Fantasía), si ella ya tiene el efecto (Apoyo Total) con todas las capas del campo restantes, las (Energía de Soporte) se generan en el campo. Cada capa de (Apoyo Total) se convierte en 2 (Energía de Soporte); (Momento de Fantasía) dura un máximo de 15s. Durante (Momento de Fantasía), el tercer nivel de (Ataque de Carga: Tono Absoluto) de Aria será mejorado a una versión potenciada; Cuando sale de (Momento de Fantasía), si ella tiene el efecto (Apoyo Total) con las capas restantes, todas las (Energía de Soporte) del campo se generarán también. Cada capa de (Apoyo Total) se convierte en 2 (Energía de Soporte). El personaje es invulnerable mientras usa esta habilidad.",
                        tags: ["Etéreo", "Técnica Definitiva"]
                    },
                    {
                        type: "Pasiva Central",
                        name: "Pasiva Central: Núcleo de Control",
                        description: "La Maestría de Anomalía aumenta en {VALOR_6} puntos.\nCuando el 3er Golpe de (Ataque Básico: Tono Absoluto) de Aria golpea un objetivo afectado por Anomalía de Atributo Etéreo, Anomalía de Atributo Eléctrico, Anomalía de Atributo Fuego, Anomalía de Atributo Físico o Anomalía de Atributo Hielo, activa una (Anomalía): Adicionalmente calcula un daño de Anomalía de Atributo. En relación al daño de Anomalía de Atributo original, cada 10 puntos de Maestría de Anomalía inicial aumenta el ratio de daño en {VALOR_1}/{VALOR_2}/{VALOR_3}/{VALOR_4}/{VALOR_5}. Cuando el objetivo está en estado de (Aturdimiento), el ratio de daño se incrementa en un 50%.",
                        tags: ["Pasiva Central"]
                    },
                    {
                        type: "Habilidad Adicional",
                    ...
                    },
                    {
                        type: "Mindscape 2",
                        name: "Talento 2: Ritmo de Sueño",
                        description: "Los ataques de Aria y al activar (Anomalía) ignoran el 12% de la DEF del objetivo; Durante la duración de (Momento de Fantasía), los ataques de Aria y al activar (Anomalía) ignoran un 12% adicional de la DEF del objetivo.",
                        tags: ["Mindscape 2"]
                    },
                    {
                        type: "Mindscape 4",
                    ...
                    },
                    {
                        type: "Mindscape 6",
                        name: "Talento 6: Sueño de Constructo",
                        description: "Al entrar en el campo de batalla, Aria inmediatamente gana 1,200 Decibeles. Durante el combate, el costo de activación se puede activar una vez cada 180s; Una vez que Aria entra en (Momento de Fantasía), ella no saldrá de él. El Daño Etéreo del (Ataque Básico Potenciado: Tono Absoluto) y (Definitiva) aumenta en un 30%. Cuando Aria está en (Momento de Fantasía), si un enemigo en el campo entra en un estado de Anomalía de Atributo, Aria gana 1 capa de (Apoyo Total). Este efecto puede activarse una vez cada 6s.",
                        tags: ["Mindscape 6"]
                    }
                ]
            }
    ...
    25: {
        ...
        versions: {
            ...
            "v2.6.3": {
                versionLabel: "v2.6.3",
                baseStats: { hp: { min: 595, max: 7405 }, atk: { min: 132, max: 915 }, def: { min: 48, max: 600 }, impact: 90, crit: "5%", critDmg: "50%", anomalyRate: "80", anomalyMastery: "95", penRatio: "0%", energyRegen: "1.2" },
                coreStats: { statName: "Prob. Critica", valuePerNode: 4.8 },
                coreSkillScaling: [["10.6%", "6%"], ["13%", "7%"], ["15.4%", "8%"], ["17.8%", "9%"], ["20.2%", "10%"], ["22.6%", "11%"], ["25%", "12%"]],
            ...
            "v2.6.4": {
                ...
                potential: { name: "Despertar Potencial: Concentración", description: "Al activar (Técnica Especial Potenciada), (Ataque en Cadena) o (Definitiva), el ATQ aumenta en un 12%; (Ataque de Carrera: Hiten no Tsuru) ignora un 5% de la RES a Daño Eléctrico del objetivo, durante 12s. Los activadores repetidos reinician la duración. La duración de (Filo Reluciente) de la (Pasiva Central) se extiende a 10s." },
                skills: [
                    { type: "Técnica Definitiva", name: "Ataque en Cadena: Convergencia", description: "Cuando un (Ataque en Cadena) es activado, selecciona el personaje para activar: Lanza ataques perforantes a enemigos en una gran área hacia adelante, y dispara flechas mejoradas, causando masivo Daño Eléctrico. Cuando la flecha golpea el suelo, puede generar 6 acumulaciones de (Prisión Electro). El personaje es invulnerable mientras usa esta habilidad.", tags: ["Eléctrico", "Ataque en Cadena"] },
                    { type: "Técnica Definitiva", name: "Definitiva: Zanshin", description: "Cuando el Nivel de Decibelios está al (Máximo), presiona [Icono Definitiva] para activar: Lanza ataques perforantes a enemigos en una gran área hacia adelante, causando masivo Daño Eléctrico. El personaje es invulnerable mientras usa esta habilidad.", tags: ["Eléctrico", "Técnica Definitiva"] },
                    { type: "Técnica Definitiva", name: "Definitiva: Zanshin - Rama", description: "Con (Filo Reluciente Afilado), (Zanshin) se activa automáticamente después de ejecutarse: Lanza ataques de penetración de gran área a enemigos en frente, causando Daño Eléctrico. Este daño cuenta como daño de (Definitiva). El personaje es invulnerable mientras usa esta habilidad.", tags: ["Eléctrico", "Técnica Definitiva"] },
                    { type: "Pasiva Central", name: "Pasiva Central: Amanecer", description: "La Prob. Crítica de (Ataque de Carrera: Hiten no Tsuru), (Evasión) y (Definitiva) aumenta en un {VALOR_1}. Cuando los ataques verdaderos de (Ataque de Carrera: Hiten no Tsuru), (Ataque de Velocidad) y (Definitiva) activan un golpe crítico contra un enemigo, obtiene 1/6 acumulaciones de (Filo Reluciente). (Ataque de Velocidad: Hiten no Tsuru) en la misma habilidad puede obtener máximo 3 acumulaciones. (Filo Reluciente) se acumula hasta 6 veces, durando 5s; los triggers repetidos reinician la duración. Cada acumulación de (Filo Reluciente) aumenta el Daño Crítico de (Ataque de Carrera: Hiten no Tsuru), (Evasión) y (Definitiva) en un {VALOR_2}.", tags: ["Pasiva Central"] },
                    { type: "Habilidad Adicional", name: "Habilidad Adicional: Overclock", description: "Cuando hay personajes de rol (Aturdidor) o de otra Facción en el equipo y se activa: Cuando los ataques de Harumasa golpean enemigos en estado de Aturdimiento o bajo estado de Anomalía de Atributo, el DAÑO propio aumenta en un 40%. Cuando las flechas de Harumasa lanzan y golpean enemigos en estado de Aturdimiento o bajo estado de Anomalía de Atributo, aplica 2 acumulaciones de (Prisión Electro).", tags: ["Habilidad Adicional"] }
                ]
            }
        }
    ...
    3: {
        ...
        versions: {
            ...
            "v2.6.3": {
                ...
                potential: { name: "Despertar Potencial: Hielo Propagado", description: "Cuando Lycaon está en estado (Coordinación), el Impacto aumenta en un 15%." },
                skills: [
                    {
                        type: "Asistencia",
