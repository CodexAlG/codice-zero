        ...
        versions: {
            ...
            "v2.7.2": {
                ...
                skills: [
                    ...
                    { type: "Técnica Especial", name: "Técnica Especial EX", description: "Cuando la energía es suficiente, pulsar o mantener pulsado [Icono Especial EX]: Lanza múltiples mordeduras de serpientes a larga distancia hacia adelante, infligiendo Daño Eléctrico; al activar el movimiento, recupera 6 puntos de energía; al mantener pulsado, consumirá energía adicionalmente, cada 20 puntos activan un golpe adicional, infligiendo Daño Eléctrico, hasta consumir un máximo de 60 puntos de energía adicionales; tras mantener pulsado, obtiene 3 puntos de (Toxina), al mantener pulsado por cada 20 puntos de energía adicionales consumidos, obtiene 1 punto de (Toxina); al golpear a un enemigo; tras lanzar el movimiento, puede conectar directamente con el cuarto golpe del (Ataque Básico: Escupir Veneno); al golpear al enemigo con el movimiento, activará (Asistencia Rápida); posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Electrico"] },
                    ...
                    { type: "Mindscape 1", name: "Viajero y Presa", description: "Al entrar al campo de batalla, los puntos de (Toxina) obtenidos aumentan a 6; el efecto de ignorar defensa enemiga en la (Pasiva Central) aumenta al 140% del original; el daño infligido por (Hueso Corrosivo) ignora un 140% de la Resistencia al Daño Eléctrico del objetivo.", tags: ["Electrico"] },
                    { type: "Mindscape 2", name: "Hambre y Mentiras", description: "Cuando la (Ataque en Cadena) o la (Técnica Definitiva) golpean a un enemigo en estado de Aturdimiento, obtiene adicionalmente 3 puntos de (Toxina); el daño infligido por (Ataque Básico: Beso de Serpiente) aumenta un 20%.", tags: ["Electrico"] },
