    ...
    52: {
        ...
        versions: {
            ...
            "v2.8.3": {
                ...
                skills: [
                    { type: "Ataque Básico", name: "Ataque Básico: Sesgo", description: "Pulsar [Icono Ataque] para activar: Realiza hasta cinco ataques hacia adelante, infligiendo Daño Hielo; Al aterrizar el quinto golpe, cuando Castigo de Escarcha es suficiente, pulsar [Icono Especial] permite conectar con Técnica Especial: Estilo de Ejecución - Veredicto; El cuarto golpe arroja la capa hacia adelante y entra en estado Perdón de Grilletes.", tags: ["Hielo"] },
                    { type: "Ataque Básico", name: "Ataque Básico: Hoja Giratoria", description: "Cuando Castigo de Escarcha es suficiente, mantener pulsado [Icono Ataque] para activar: Promeia salta hacia arriba y lanza un ataque, arrojando la capa junto al enemigo para entrar en estado Perdón de Grilletes, infligiendo Daño Hielo; Al golpear a un enemigo, no acumula Erosión de Frío.", tags: ["Hielo"] },
                    { type: "Ataque Básico", name: "Perdón de Grilletes", description: "Promeia arroja la capa al lanzar ciertos movimientos, la cual continuará cortando al enemigo, infligiendo Daño Hielo; Mientras la capa está arrojada, Promeia puede caminar lentamente; Durante este periodo, pulsar [Icono Ataque] permite conectar directamente con el quinto golpe de Ataque Básico: Sesgo; Durante este periodo al recibir un ataque puede activar automáticamente Evasión Perfecta, el efecto de evasión se activa como máximo una vez cada 20 segundos.", tags: ["Hielo"] },
                    ...
                    { type: "Evasión", name: "Ataque de Carrera", description: "Al evadir, pulsar [Icono Ataque] para activar: Realiza un ataque rápido hacia adelante, infligiendo Daño Hielo.", tags: ["Hielo"] },
                    { type: "Evasión", name: "Contraataque de Evasión", description: "Tras activar Evasión Perfecta, pulsar [Icono Ataque] para activar: Lanza ataques continuos al objetivo, infligiendo Daño Hielo; Tras lanzar el movimiento, puede conectar directamente con el quinto golpe de Ataque Básico: Sesgo; Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Asistencia", name: "Asistencia Rápida", description: "Cuando el personaje actualmente en uso es lanzado por los aires, pulsar [Icono Assist] para activar: Lanza ataques continuos al objetivo, infligiendo Daño Hielo; Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Asistencia", name: "Asistencia Defensiva", description: "Cuando el personaje en el campo está a punto de ser atacado, pulsar [Icono Assist] para activar: Realiza una parada al ataque enemigo, acumulando una gran cantidad de valor de Aturdimiento; Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Asistencia", name: "Intercepción", description: "Tras activar Asistencia Defensiva, pulsar [Icono Ataque] para activar: Lanza ataques continuos al objetivo, infligiendo Daño Hielo; Tras lanzar el movimiento, puede conectar directamente con el quinto golpe de Ataque Básico: Sesgo; Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial: Estilo de Ejecución - Destello Helado", description: "Pulsar [Icono Especial] para activar: Lanza un ataque de dardos, infligiendo Daño Hielo.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Estilo de Ejecución - Sendero de Escarcha Degollador", description: "Cuando la energía es suficiente, pulsar [Icono Especial] para activar: Lanza un ataque de dardos, y arroja la capa junto al enemigo entrando en estado Perdón de Grilletes, infligiendo Daño Hielo; Si recibe un ataque enemigo en un corto periodo de tiempo tras iniciar el movimiento, conectará automáticamente con Técnica Especial EX: Estilo de Ejecución - Sombra Oculta; Al activar el movimiento, Promeia obtiene el efecto Regla de Hierro; Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Estilo de Ejecución - Sombra Oculta", description: "Se activa automáticamente si recibe un ataque en un corto periodo de tiempo tras lanzar Técnica Especial: Estilo de Ejecución - Sendero de Escarcha Degollador: Activa por un corto tiempo la Visión Extrema, y se mueve rápidamente detrás del enemigo; Tras activar Evasión Perfecta, si la energía es suficiente, pulsar [Icono Especial EX] permite consumir 40 puntos de energía para activar Técnica Especial EX: Estilo de Ejecución - Sombra Oculta, y obtiene el efecto Regla de Hierro; Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Estilo de Ejecución - Escarcha Cayendo", description: "Al poseer el efecto Regla de Hierro, en estado Perdón de Grilletes pulsar [Icono Ataque] o pulsar [Icono Dodges] para activar: Salta hacia el enemigo, recuperando la capa al mismo tiempo que realiza un ataque descendente, infligiendo Daño Hielo; Tras aterrizar, si posee Castigo de Escarcha, pulsar o mantener pulsado [Icono Especial EX] permite conectar con Técnica Especial: Estilo de Ejecución - Veredicto; Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
