    ...
    52: {
        ...
        versions: {
            ...
            "v2.8.3": {
                ...
                skills: [
                    { type: "Ataque Básico", name: "Ataque Básico: Sesgo", description: "Pulsar [Icono Ataque] para activar: Realiza hasta cinco ataques hacia adelante, infligiendo Daño Hielo; Al aterrizar el quinto golpe, cuando (Castigo de Escarcha) es suficiente, pulsar [Icono Especial] permite conectar con la (Técnica Especial: Estilo de Ejecución - Veredicto); El cuarto golpe arrojará la capa y luego entrará en estado de (Perdón de Grilletes).", tags: ["Hielo"] },
                    { type: "Ataque Básico", name: "Ataque Cargado: Cuchilla Giratoria", description: "Cuando (Castigo de Escarcha) es suficiente, mantener pulsado [Icono Ataque] para activar: Promeia salta hacia arriba y lanza un ataque, arrojando la capa junto al enemigo para entrar en estado de (Perdón de Grilletes), infligiendo Daño Hielo; Cuando golpea a un enemigo, no acumula (Erosión de Frío).", tags: ["Hielo"] },
                    { type: "Ataque Básico", name: "Perdón de Grilletes", description: "Promeia arrojará su capa al ejecutar ciertos movimientos, cortando continuamente a los enemigos, infligiendo Daño Hielo; mientras la capa está arrojada, Promeia puede caminar lentamente; durante este periodo pulsar [Icono Ataque] permite conectar directamente con el quinto golpe del (Ataque Básico: Sesgo); durante este periodo si recibe un ataque puede activar automáticamente una (Evasión Perfecta), el efecto de evasión se activa como máximo una vez cada 20 segundos.", tags: ["Hielo"] },
                    { type: "Evasión", name: "Evasión: Paso de Nieve", description: "Pulsar [Icono Dodges] para activar: Una esquiva rápida de carrera; posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Evasión", name: "Ataque de Carrera: Saqueo de Vida", description: "Al evadir, pulsar [Icono Ataque] para activar: Realiza un ataque rápido hacia adelante, infligiendo Daño Hielo.", tags: ["Hielo"] },
                    ...
                    { type: "Técnica Especial", name: "Técnica Especial: Estilo de Ejecución - Destello Helado", description: "Pulsar [Icono Especial] para activar: Lanza un ataque de dardos, infligiendo Daño Hielo.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Estilo de Ejecución - Sendero de Escarcha Degollador", description: "Se activa automáticamente si recibe un ataque poco después de lanzar (Técnica Especial EX: Estilo de Ejecución - Sendero de Escarcha Degollador): Activa por un corto tiempo la (Visión Extrema), y se mueve rápidamente detrás del enemigo; Tras activar (Evasión Perfecta), si la energía es suficiente, pulsar [Icono Especial EX] permite consumir 40 puntos de energía para activar este movimiento y obtener el efecto (Regla de Hierro); Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Estilo de Ejecución - Sombra Oculta", description: "Se activa automáticamente si recibe un ataque poco después de lanzar (Técnica Especial EX: Estilo de Ejecución - Sendero de Escarcha Degollador): Activa por un corto tiempo la (Visión Extrema), y se mueve rápidamente detrás del enemigo; Tras activar (Evasión Perfecta), si la energía es suficiente, pulsar [Icono Especial EX] permite consumir 40 puntos de energía para activar la (Técnica Especial EX: Estilo de Ejecución - Sombra Oculta), y obtiene el efecto (Regla de Hierro); Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Estilo de Ejecución - Escarcha Cayendo", description: "Al poseer el efecto (Regla de Hierro), en estado de (Perdón de Grilletes) pulsar [Icono Ataque] o pulsar [Icono Dodges] para activar: Salta hacia el enemigo, recuperando la capa mientras realiza un ataque descendente, infligiendo Daño Hielo; tras aterrizar, si posee (Castigo de Escarcha), pulsar o mantener pulsado [Icono Especial] permite conectar con la (Técnica Especial EX: Estilo de Ejecución - Veredicto); posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Estilo de Ejecución - Escarcha Pesada", description: "Tras activar (Técnica Especial EX: Estilo de Ejecución - Sombra Oculta), pulsar [Icono Ataque] o [Icono Dodges] para activar: Lanza rápidamente múltiples ataques, luego salta hacia el enemigo recuperando la capa mientras realiza un ataque descendente más potente, infligiendo Daño Hielo; tras aterrizar, si posee (Castigo de Escarcha), pulsar o mantener pulsado [Icono Especial] permite conectar con la (Técnica Especial EX: Estilo de Ejecución - Veredicto); posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Estilo de Ejecución - Veredicto", description: "Tras el último golpe del (Ataque Básico: Sesgo), de (Escarcha Cayendo) o de (Escarcha Pesada), cuando (Castigo de Escarcha) es suficiente, mantener pulsado [Icono Ataque], [Icono Especial] o pulsar [Icono Especial] para activar: Realiza una rápida esquiva hacia atrás al mismo tiempo que asesta un golpe final más poderoso, infligiendo Daño Hielo; Al golpear a un enemigo, no acumula (Erosión de Frío); Tras activarse, se puede conectar directamente con el quinto golpe del (Ataque Básico: Sesgo) manteniendo pulsado [Icono Ataque], [Icono Especial] o pulsando [Icono Ataque]; Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Definitiva", name: "Ataque en Cadena: Liquidación Invertida", description: "Al activar (Ataque en Cadena), seleccionar al personaje: Lanza dardos, colgando boca abajo sobre el enemigo realizando múltiples ataques, seguido de un golpe final, infligiendo una gran cantidad de Daño Hielo; Al golpear a un enemigo en estado de Anomalía, activa 1 vez el efecto (Abloom), calculando de forma fija el 100% del multiplicador correspondiente; Tras lanzar el movimiento, se puede conectar directamente con el quinto golpe del (Ataque Básico: Sesgo); Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Definitiva", name: "Técnica Definitiva: Castigo Perforahuesos", description: "Con decibelios al (Máximo), pulsar [Icono Definitiva]: Realiza múltiples ataques hacia adelante, infligiendo una gran cantidad de Daño Hielo; Al golpear a un enemigo en estado de Anomalía, activa 1 vez el efecto (Abloom), calculando de forma fija el 250% del multiplicador correspondiente; Tras lanzar el movimiento, se puede conectar directamente con el quinto golpe del (Ataque Básico: Sesgo); Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Pasiva Central", name: "Pasiva Central: Fuego Robado", description: "Si la Tasa de Anomalía inicial de Promeia es mayor a 140 puntos, cada 1 punto excedente aumentará su propia Maestría de Anomalía en 1.5 puntos, y aumenta un 0.32% el daño de Abloom infligido por todo el equipo; Al golpear con diferentes ataques, Promeia recupera Erosión de Frío; cuando un aliado activa Congelación, Desorden, Turbulencia, o ella usa Sombra Oculta, recupera adicionalmente 5/5/5/10 puntos de Erosión de Frío (máx. 100); Cuando un aliado activa Abloom y golpea a un enemigo, Promeia recupera adicionalmente 15 puntos de Erosión de Frío, se activa cada 0.1s; Si la Erosión de Frío es mayor o igual a 50 puntos, los consume para obtener 1 punto de Castigo de Escarcha (máx. 2); al entrar al combate, obtiene 2 puntos de Castigo de Escarcha; Al hacer que el golpe final de Veredicto golpee a un enemigo en estado de Anomalía, consume 1 punto de Castigo de Escarcha para activar Abloom, calculando de forma fija el {VALOR_1} del multiplicador correspondiente; Al activar Abloom propia recupera 100 decibelios; si lo hacen aliados, ella recupera 150 decibelios para ella; Al activar la Técnica Definitiva: Castigo Perforahuesos, obtiene el efecto Helada: tras usar Veredicto, Ataque en Cadena o Técnica Definitiva, pulsar o mantener pulsado [Icono Especial] consume Helada para conectar directamente con Escarcha Pesada.", tags: ["Hielo"] },
                    { type: "Habilidad Adicional", name: "Habilidad Adicional: Beber Hielo", description: "Se activa cuando existe otro personaje de (Anomalía) o (Soporte) en el equipo: Al activar la (Técnica Especial EX), la Eficiencia de Acumulación de Atributo Hielo de Promeia aumenta en un 30%, con una duración de 30 segundos, al activarse de nuevo se reinicia la duración; Cuando cualquier personaje del equipo aplica el efecto (Congelación) a un enemigo, la duración de dicho efecto aumenta en 3 segundos; Cuando la (Técnica Especial EX) de Promeia golpea a un enemigo, aplica (Presunción de Culpabilidad): todo el equipo ignora un 40% de defensa al infligir daño mediante (Abloom) a enemigos afectados.", tags: ["Hielo"] },
                    { type: "Mindscape 1", name: "Ideal Inocente", description: "Al usar (Definitiva), obtiene 1 punto de (Castigo de Escarcha) si no está al máximo; tras la (Definitiva), todo el equipo ignora un 15% de defensa contra enemigos en estado de (Presunción de Culpabilidad) al causar (Abloom)."},
                    { type: "Mindscape 2", name: "Fe Tambaleante", description: "La Maestría de Anomalía de Promeia aumenta 60 puntos; el multiplicador del efecto de (Abloom) causado al consumir (Castigo de Escarcha) aumenta un 165%."},
                    { type: "Mindscape 3", name: "Luna Cruel", description: "Nivel de Ataque Básico, Evasión, Asistencia, Técnica Especial y Ataque en Cadena +2", tags: ["Electrico"] },
                    { type: "Mindscape 4", name: "Acusación Cruel", description: "Cuando Promeia activa el efecto (Abloom), recupera 5 puntos de (Erosión de Frío), se activa como máximo una vez cada 0.5 segundos."},
                    { type: "Mindscape 5", name: "Polilla Moribunda", description: "Nivel de Ataque Básico, Evasión, Asistencia, Técnica Especial y Ataque en Cadena +2", tags: ["Electrico"] },
                    { type: "Mindscape 6", name: "Historia Continuará...", description: "Al consumir (Castigo de Escarcha) para activar (Abloom), activa adicionalmente una vez un efecto especial de (Abloom), calculando de forma fija un multiplicador del 200% del daño de Anomalía de Atributo correspondiente, y al mismo tiempo recupera 5 puntos de (Erosión de Frío) y 100 puntos de decibelios, este efecto se activa como máximo una vez cada 15 segundos; además, el daño de Anomalía de Atributo y el daño de (Desorden) infligido por Promeia ignora un 15% de la Resistencia a Todos los Atributos del enemigo."}
