        ...
        versions: {
            "v2.8.0": {
                ...
                skills: [
                    ...
                    { type: "Mindscape 1", name: "Mindscape 1", description: "Descripción de Mindscape 1", tags: ["Hielo"] },
                    { type: "Mindscape 2", name: "Mindscape 2", description: "Descripción de Mindscape 2", tags: ["Hielo"] },
                    { type: "Mindscape 3", name: "Mindscape 3", description: "Descripción de Mindscape 3", tags: ["Hielo"] },
                    { type: "Mindscape 4", name: "Mindscape 4", description: "Descripción de Mindscape 4", tags: ["Hielo"] },
                    { type: "Mindscape 5", name: "Mindscape 5", description: "Descripción de Mindscape 5", tags: ["Hielo"] },
                    { type: "Mindscape 6", name: "Mindscape 6", description: "Descripción de Mindscape 6", tags: ["Hielo"] }
                ]
            },
            "v2.8.1": {
                versionLabel: "v2.8.1",
            ...
            "v2.8.2": {
                ...
                skills: [
                    ...
                    { type: "Asistencia", name: "Ataque de Asistencia: Intercepción", description: "Tras activar (Asistencia Defensiva), pulsar [Icono Ataque] para activar: Lanza ataques continuos contra el objetivo, infligiendo Daño Hielo; posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial: Estilo de Ejecución - Destello Helado", description: "Pulsar [Icono Especial] para activar: Lanza un ataque de dardos, infligiendo Daño Hielo.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Estilo de Ejecución - Sendero de Escarcha Degollador", description: "Cuando la energía es suficiente, pulsar [Icono Especial EX] para activar: Lanza un ataque de dardos y arroja la capa junto al enemigo entrando en estado de (Perdón de Grilletes), infligiendo Daño Hielo; si recibe un ataque enemigo poco después de iniciar el movimiento, conectará automáticamente con la (Técnica Especial EX: Estilo de Ejecución - Sombra Oculta); al activar el movimiento, Promeia obtiene el efecto (Regla de Hierro); posee efecto de invencibilidad durante la ejecución del movimiento", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Estilo de Ejecución - Sombra Oculta", description: "Se activa automáticamente si recibe un ataque poco después de lanzar (Técnica Especial EX: Estilo de Ejecución - Sendero de Escarcha Degollador): Activa por un corto tiempo la (Visión Extrema), y se mueve rápidamente detrás del enemigo; Tras activar (Evasión Perfecta), si la energía es suficiente, pulsar [Icono Especial EX] permite consumir 40 puntos de energía para activar la (Técnica Especial EX: Estilo de Ejecución - Sombra Oculta), y obtiene el efecto (Regla de Hierro); Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Estilo de Ejecución - Escarcha Cayendo", description: "Al poseer el efecto (Regla de Hierro), en estado de (Perdón de Grilletes) pulsar [Icono Ataque] o pulsar [Icono Dodges] para activar: Salta hacia el enemigo, recuperando la capa mientras realiza un ataque descendente, infligiendo Daño Hielo; tras aterrizar, si posee (Castigo de Escarcha), pulsar o mantener pulsado [Icono Especial] permite conectar con la (Técnica Especial EX: Estilo de Ejecución - Veredicto); posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Estilo de Ejecución - Escarcha Pesada", description: "Tras activar (Técnica Especial EX: Estilo de Ejecución - Sombra Oculta), pulsar [Icono Ataque] o [Icono Dodges] para activar: Lanza rápidamente múltiples ataques, luego salta hacia el enemigo recuperando la capa mientras realiza un ataque descendente más potente, infligiendo Daño Hielo; tras aterrizar, si posee (Castigo de Escarcha), pulsar o mantener pulsado [Icono Especial] permite conectar con la (Técnica Especial EX: Estilo de Ejecución - Veredicto); posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Estilo de Ejecución - Veredicto", description: "Tras el último golpe del (Ataque Básico: Sesgo), de la (Técnica Especial EX: Estilo de Ejecución - Escarcha Cayendo) o de la (Técnica Especial EX: Estilo de Ejecución - Escarcha Pesada), si el (Castigo de Escarcha) es suficiente, pulsar o mantener pulsado [Icono Especial] para activar: Realiza una rápida esquiva hacia atrás al mismo tiempo que asesta un golpe final más poderoso, infligiendo Daño Hielo; posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Definitiva", name: "Ataque en Cadena: Liquidación Invertida", description: "Al activar un (Ataque en Cadena), seleccionar al personaje correspondiente para activar: Lanza dardos, colgando boca abajo sobre el enemigo realizando múltiples ataques, seguido de un golpe final, infligiendo una gran cantidad de Daño Hielo; Cuando el golpe pesado golpea a un enemigo en estado de Anomalía de Atributo Hielo, estado de Anomalía de Atributo Éter, estado de Anomalía de Atributo Eléctrico, estado de Anomalía de Atributo Fuego, estado de Anomalía de Atributo Físico o estado de Anomalía de Atributo Viento, activa 1 vez el efecto (Abloom), calculando de forma fija una vez el 200% del multiplicador de daño de Anomalía de Atributo correspondiente; Tras lanzar el movimiento, se puede conectar directamente con el cuarto golpe del (Ataque Básico: Sesgo); Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Definitiva", name: "Técnica Definitiva: Castigo Perforahuesos", description: "Cuando el nivel de decibelios llega a (Máximo), pulsar [Icono Definitiva] para activar: Realiza múltiples ataques hacia adelante, infligiendo una gran cantidad de Daño Hielo; Cuando el golpe pesado golpea a un enemigo en estado de Anomalía de Atributo Hielo, estado de Anomalía de Atributo Éter, estado de Anomalía de Atributo Eléctrico, estado de Anomalía de Atributo Fuego, estado de Anomalía de Atributo Físico o estado de Anomalía de Atributo Viento, activa 1 vez el efecto (Abloom), calculando de forma fija una vez el 500% del multiplicador del daño de Anomalía de Atributo correspondiente; Tras lanzar el movimiento, se puede conectar directamente con el cuarto golpe del (Ataque Básico: Sesgo); Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Pasiva Central", name: "Pasiva Central: Fuego Robado", description: "Si la Tasa de Anomalía inicial de Promeia es mayor a 140 puntos, cada 1 punto que exceda la Tasa de Anomalía inicial aumentará su propia Maestría de Anomalía en 1.5 puntos, y aumenta un 0.28% el daño de (Abloom) infligido por todo el equipo; al golpear a los enemigos con diferentes ataques, Promeia recupera una cierta cantidad de (Erosión de Frío), cuando un personaje del equipo activa el efecto (Congelación), el efecto (Desorden), el efecto (Turbulencia), o se activa la (Técnica Especial EX: Estilo de Ejecución - Sombra Oculta), recupera adicionalmente 5/5/5/10 puntos de (Erosión de Frío), pudiendo acumular hasta un máximo de 100 puntos de (Erosión de Frío); cuando el efecto (Abloom) activado por un compañero de equipo golpea a un enemigo, Promeia recupera adicionalmente 12 puntos de (Erosión de Frío); si la (Erosión de Frío) es mayor o igual a 50 puntos, consumirá 50 puntos de (Erosión de Frío), convirtiéndolos en 1 punto de (Castigo de Escarcha), pudiendo obtener hasta un máximo de 2 puntos de (Castigo de Escarcha); Al entrar al campo de batalla, Promeia obtiene 2 puntos de (Castigo de Escarcha); al hacer que el golpe final de la (Técnica Especial EX: Estilo de Ejecución - Veredicto) activado golpee a un enemigo en estado de Anomalía de Atributo Hielo, estado de Anomalía de Atributo Éter, estado de Anomalía de Atributo Eléctrico, estado de Anomalía de Atributo Fuego, estado de Anomalía de Atributo Físico o estado de Anomalía de Atributo Viento, consume 1 punto de (Castigo de Escarcha) para activar 1 vez el efecto (Abloom), calculando de forma fija el 800% del multiplicador de daño de Anomalía de Atributo correspondiente; cuando el efecto (Abloom) activado por Promeia golpea a un enemigo, recupera adicionalmente 100 puntos de decibelios, al activar la (Técnica Definitiva: Castigo Perforahuesos), Promeia obtiene el siguiente efecto: Tras activar (Técnica Especial EX: Estilo de Ejecución - Veredicto), (Ataque en Cadena: Liquidación Invertida) o (Técnica Definitiva: Castigo Perforahuesos), pulsar o mantener pulsado [Icono Especial] permite conectar directamente con la (Técnica Especial EX: Estilo de Escarcha Pesada); Este efecto se puede activar una vez tras lanzar la (Técnica Definitiva: Castigo Perforahuesos).", tags: ["Hielo"] },
                    { type: "Habilidad Adicional", name: "Habilidad Adicional: Beber Hielo", description: "Se activa cuando existe otro personaje de (Anomalía) o personaje de (Soporte) en el equipo: Al activar la (Técnica Especial EX), la Eficiencia de Acumulación de Atributo Hielo de Promeia aumenta en un 30%, con una duración de 30 segundos, al activarse de nuevo se reinicia la duración; cuando la (Técnica Especial EX) de Promeia golpea a un enemigo, el enemigo obtiene el estado de (Presunción de Culpabilidad), cuando cualquier personaje de todo el equipo inflige daño a un enemigo en estado de (Presunción de Culpabilidad) mediante el efecto de (Abloom) ignora un 35% de defensa, el estado de (Presunción de Culpabilidad) dura 30 segundos, al activarse de nuevo se reinicia la duración.", tags: ["Hielo"] },
                    { type: "Mindscape 1", name: "Mindscape 1", description: "Cuando Promeia activa la (Técnica Definitiva: Castigo Perforahuesos), obtiene un efecto adicional: Si la cantidad de (Castigo de Escarcha) no está al máximo, obtiene 1 punto de (Castigo de Escarcha), este efecto se puede activar una vez tras activar la (Técnica Definitiva: Castigo Perforahuesos); tras activar la (Técnica Especial EX: Estilo de Ejecución - Veredicto), se puede conectar rápidamente al último golpe del (Ataque Básico: Sesgo) manteniendo pulsado [Icono Ataque] o [Icono Especial]; el Daño Hielo infligido por Promeia aumenta un 30%." },
                    { type: "Mindscape 2", name: "Mindscape 2", description: "El daño de Anomalía de Atributo y el daño de (Desorden) infligido por Promeia a los enemigos en estado de (Presunción de Culpabilidad) ignora un 15% adicional de defensa; el multiplicador del efecto de (Abloom) causado al consumir (Castigo de Escarcha) aumenta un 300%." },
                    { type: "Mindscape 4", name: "Mindscape 4", description: "Cuando Promeia activa el efecto (Abloom), recupera 0 puntos de (Erosión de Frío)." },
                    { type: "Mindscape 6", name: "Mindscape 6", description: "Cuando Promeia consume (Castigo de Escarcha) para activar el efecto de (Abloom), activa adicionalmente una vez un efecto especial de (Abloom), calculando de forma fija un multiplicador del 300% del daño de Anomalía de Atributo correspondiente, este efecto se activa como máximo una vez cada 5 segundos; además, el daño de Anomalía de Atributo y el daño de (Desorden) infligido por Promeia ignora un 20% de la Resistencia a Todos los Atributos del enemigo." }
                ...
                hotfixes: [
                    {
                        ...
                        date: "2026-04-04",
                        skills: [
                            { type: "Mindscape 1", name: "Mindscape 1", description: "Cuando Promeia activa la (Técnica Definitiva: Castigo Perforahuesos), obtiene un efecto adicional: Si la cantidad de (Castigo de Escarcha) no está al máximo, obtiene 1 punto de (Castigo de Escarcha), este efecto se puede activar una vez tras activar la (Técnica Definitiva: Castigo Perforahuesos); tras activar la (Técnica Especial EX: Estilo de Ejecución - Veredicto), se puede conectar rápidamente al último golpe del (Ataque Básico: Sesgo) manteniendo pulsado [Icono Ataque] o [Icono Especial]; el Daño Hielo infligido por Promeia aumenta un 15%." },
                            { type: "Mindscape 2", name: "Mindscape 2", description: "El daño de Anomalía de Atributo y el daño de (Desorden) infligido por Promeia a los enemigos en estado de (Presunción de Culpabilidad) ignora un 15% adicional de defensa; el multiplicador del efecto de (Abloom) causado al consumir (Castigo de Escarcha) aumenta un 200%." },
                            ...
                            { type: "Mindscape 4", name: "Mindscape 4", description: "Cuando Promeia activa el efecto (Abloom), recupera 6 puntos de (Erosión de Frío)." },
                            ...
                            { type: "Mindscape 6", name: "Mindscape 6", description: "Cuando Promeia consume (Castigo de Escarcha) para activar el efecto de (Abloom), activa adicionalmente una vez un efecto especial de (Abloom), calculando de forma fija un multiplicador del 400% del daño de Anomalía de Atributo correspondiente, este efecto se activa como máximo una vez cada 15 segundos; además, el daño de Anomalía de Atributo y el daño de (Desorden) infligido por Promeia ignora un 15% de la Resistencia a Todos los Atributos del enemigo." }
                        ]
                    }
                ]
            },
            "v2.8.3": {
                ...
                skills: [
                    { type: "Ataque Básico", name: "Ataque Básico: Sesgo", description: "Pulsar [Icono Ataque] para activar: Realiza hasta cinco ataques hacia adelante, infligiendo Daño Hielo; Al aterrizar el quinto golpe, cuando (Castigo de Escarcha) es suficiente, pulsar [Icono Especial] permite conectar con la (Técnica Especial: Estilo de Ejecución - Veredicto); El cuarto golpe arroja la capa hacia adelante y entra en estado de (Perdón de Grilletes).", tags: ["Hielo"] },
                    { type: "Ataque Básico", name: "Ataque Básico: Hoja Giratoria", description: "Cuando (Castigo de Escarcha) es suficiente, mantener pulsado [Icono Ataque] para activar: Promeia salta hacia arriba y lanza un ataque, arrojando la capa junto al enemigo para entrar en estado de (Perdón de Grilletes), infligiendo Daño Hielo; Al golpear a un enemigo, no acumula (Erosión de Frío).", tags: ["Hielo"] },
                    { type: "Ataque Básico", name: "Perdón de Grilletes", description: "Promeia arroja la capa al lanzar ciertos movimientos, la cual continuará cortando al enemigo, infligiendo Daño Hielo; Mientras la capa está arrojada, Promeia puede caminar lentamente; Durante este periodo, pulsar [Icono Ataque] permite conectar directamente con el quinto golpe del (Ataque Básico: Sesgo); Durante este periodo al recibir un ataque puede activar automáticamente (Evasión Perfecta), el efecto de evasión se activa como máximo una vez cada 20 segundos.", tags: ["Hielo"] },
                    { type: "Evasión", name: "Evasión: Paso Cercano", description: "Pulsar [Icono Dodges] para activar: Una esquiva rápida de carrera; Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Evasión", name: "Ataque de Carrera: Saqueo de Vida", description: "Al evadir, pulsar [Icono Ataque] para activar: Realiza un ataque rápido hacia adelante, infligiendo Daño Hielo.", tags: ["Hielo"] },
                    { type: "Evasión", name: "Contraataque de Evasión: Salto de Murciélago", description: "Tras activar (Evasión Perfecta), pulsar [Icono Ataque] para activar: Lanza ataques continuos al objetivo, infligiendo Daño Hielo; Tras lanzar el movimiento, puede conectar directamente con el quinto golpe del (Ataque Básico: Sesgo); Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Asistencia", name: "Asistencia Rápida: Ataque Plegado", description: "Cuando el personaje actualmente en uso es lanzado por los aires, pulsar [Icono Assist] para activar: Lanza ataques continuos al objetivo, infligiendo Daño Hielo; Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Asistencia", name: "Asistencia Defensiva: Prohibición", description: "Cuando el personaje en el campo está a punto de ser atacado, pulsar [Icono Assist] para activar: Realiza una parada al ataque enemigo, acumulando una gran cantidad de valor de Aturdimiento; Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Asistencia", name: "Ataque de Asistencia: Intercepción", description: "Tras activar (Asistencia Defensiva), pulsar [Icono Ataque] para activar: Lanza ataques continuos al objetivo, infligiendo Daño Hielo; Tras lanzar el movimiento, puede conectar directamente con el quinto golpe del (Ataque Básico: Sesgo); Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial: Estilo de Ejecución - Destello Helado", description: "Pulsar [Icono Especial] para activar: Lanza un ataque de dardos, infligiendo Daño Hielo.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Estilo de Ejecución - Sendero de Escarcha Degollador", description: "Cuando la energía es suficiente, pulsar [Icono Especial] para activar: Lanza un ataque de dardos, y arroja la capa junto al enemigo entrando en estado de (Perdón de Grilletes), infligiendo Daño Hielo; Si recibe un ataque enemigo en un corto periodo de tiempo tras iniciar el movimiento, conectará automáticamente con la (Técnica Especial EX: Estilo de Ejecución - Sombra Oculta); Al activar el movimiento, Promeia obtiene el efecto de (Regla de Hierro); Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Estilo de Ejecución - Sombra Oculta", description: "Se activa automáticamente si recibe un ataque en un corto periodo de tiempo tras lanzar la (Técnica Especial EX: Estilo de Ejecución - Sendero de Escarcha Degollador): Activa por un corto tiempo la (Visión Extrema), y se mueve rápidamente detrás del enemigo; Tras activar (Evasión Perfecta), si la energía es suficiente, pulsar [Icono Especial EX] permite consumir 40 puntos de energía para activar la (Técnica Especial EX: Estilo de Ejecución - Sombra Oculta), y obtiene el efecto de (Regla de Hierro); Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Estilo de Ejecución - Escarcha Cayendo", description: "Al poseer el efecto (Regla de Hierro), en estado de (Perdón de Grilletes) pulsar [Icono Ataque] o pulsar [Icono Dodges] para activar: Salta hacia el enemigo, recuperando la capa al mismo tiempo que realiza un ataque descendente, infligiendo Daño Hielo; Tras aterrizar, si posee (Castigo de Escarcha), pulsar o mantener pulsado [Icono Especial EX] permite conectar con la (Técnica Especial: Estilo de Ejecución - Veredicto); Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Estilo de Ejecución - Escarcha Pesada", description: "Tras activar la (Técnica Especial EX: Estilo de Ejecución - Sombra Oculta), pulsar [Icono Ataque] o [Icono Dodges] para activar: Lanza rápidamente múltiples ataques, luego salta hacia el enemigo, recuperando la capa al mismo tiempo que realiza un ataque descendente más potente, infligiendo Daño Hielo; Tras aterrizar, si posee (Castigo de Escarcha), pulsar o mantener pulsado [Icono Especial EX] permite conectar con la (Técnica Especial: Estilo de Ejecución - Veredicto); Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Especial", name: "Técnica Especial: Estilo de Ejecución - Veredicto", description: "Tras lanzar el último golpe del (Ataque Básico: Sesgo), la (Técnica Especial EX: Estilo de Ejecución - Escarcha Cayendo), o la (Técnica Especial EX: Estilo de Ejecución - Escarcha Pesada), cuando (Castigo de Escarcha) es suficiente, mantener pulsado [Icono Ataque], [Icono Especial] o pulsar [Icono Especial] para activar: Realiza una rápida esquiva hacia atrás saltando al mismo tiempo que asesta un golpe final más poderoso, infligiendo Daño Hielo; Al golpear a un enemigo, no acumula (Erosión de Frío); Tras activarse el movimiento, se puede conectar directamente con el quinto golpe del (Ataque Básico: Sesgo) manteniendo pulsado [Icono Ataque], [Icono Especial] o pulsando [Icono Especial]; Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Definitiva", name: "Ataque en Cadena: Liquidación Invertida", description: "Al activar el (Ataque en Cadena), seleccionar al personaje correspondiente para activar: Lanza dardos, colgando boca abajo sobre el enemigo realizando múltiples ataques, seguido de un golpe final, infligiendo una gran cantidad de Daño Hielo; Cuando el golpe pesado golpea a un enemigo en estado de Anomalía de Atributo Hielo, estado de Anomalía de Atributo Éter, estado de Anomalía de Atributo Eléctrico, estado de Anomalía de Atributo Fuego, estado de Anomalía de Atributo Físico o estado de Anomalía de Atributo Viento, activa 1 vez el efecto (Abloom), calculando una vez el 100% del multiplicador de daño de Anomalía de Atributo correspondiente; Tras lanzar el movimiento, se puede conectar directamente con el quinto golpe del (Ataque Básico: Sesgo); Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Técnica Definitiva", name: "Técnica Definitiva: Castigo Perforahuesos", description: "Cuando el nivel de decibelios llega a (Máximo), pulsar [Icono Definitiva] para activar: Realiza múltiples ataques hacia adelante, infligiendo una gran cantidad de Daño Hielo; Cuando el golpe pesado golpea a un enemigo en estado de Anomalía de Atributo Hielo, estado de Anomalía de Atributo Éter, estado de Anomalía de Atributo Eléctrico, estado de Anomalía de Atributo Fuego, estado de Anomalía de Atributo Físico o estado de Anomalía de Atributo Viento, activa 1 vez el efecto (Abloom), calculando una vez el 250% del multiplicador de daño de Anomalía de Atributo correspondiente; Tras lanzar el movimiento, se puede conectar directamente con el quinto golpe del (Ataque Básico: Sesgo); Posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Hielo"] },
                    { type: "Pasiva Central", name: "Pasiva Central: Fuego Robado", description: "Si la Tasa de Anomalía inicial de Promeia es mayor a 140 puntos, cada 1 punto que exceda la Tasa de Anomalía inicial aumentará su propia Maestría de Anomalía en 1.5 puntos, y aumenta un 0.32% el daño de (Abloom) infligido por todo el equipo; Cuando los diferentes ataques de Promeia golpean a un enemigo recupera una cierta cantidad de (Erosión de Frío), cuando un personaje del equipo activa el efecto (Congelación), el efecto (Desorden), el efecto (Turbulencia), o se activa la (Técnica Especial EX: Estilo de Ejecución - Sombra Oculta), recupera adicionalmente 5/5/5/10 puntos de (Erosión de Frío), acumulando como máximo 100 puntos de (Erosión de Frío); Cuando el efecto (Abloom) activado por un compañero de equipo golpea a un enemigo, Promeia recupera adicionalmente 15 puntos de (Erosión de Frío), se activa como máximo una vez cada 0.1 segundos; Si la (Erosión de Frío) es mayor o igual a 50 puntos, entonces consume 50 puntos de (Erosión de Frío), transformándose en 1 punto de (Castigo de Escarcha), obteniendo como máximo 2 puntos de (Castigo de Escarcha); Al entrar al campo de batalla, Promeia obtiene 2 puntos de (Castigo de Escarcha); Al hacer que el golpe final de la (Técnica Especial: Estilo de Ejecución - Veredicto) golpee a un enemigo en estado de Anomalía de Atributo Hielo, estado de Anomalía de Atributo Éter, estado de Anomalía de Atributo Eléctrico, estado de Anomalía de Atributo Fuego, estado de Anomalía de Atributo Físico o estado de Anomalía de Atributo Viento, consume 1 punto de (Castigo de Escarcha) para activar 1 vez el efecto (Abloom), calculando de forma fija el {VALOR_1} del multiplicador de daño de Anomalía de Atributo correspondiente; Cuando el efecto (Abloom) activado por Promeia golpea a un enemigo recupera adicionalmente 100 puntos de decibelios, en 0.5 segundos se activa como máximo una vez; cuando el efecto (Abloom) activado por un compañero de equipo golpea a un enemigo, Promeia recupera adicionalmente 150 puntos de decibelios, se activa como máximo una vez cada 0.1 segundos; Al activar la (Técnica Definitiva: Castigo Perforahuesos), Promeia obtiene el efecto (Helada), al poseer el efecto (Helada), tras activar la (Técnica Especial: Estilo de Ejecución - Veredicto), el (Ataque en Cadena) o la (Técnica Definitiva), pulsar o mantener pulsado [Icono Especial EX] permite consumir el efecto (Helada) para conectar directamente con la (Técnica Especial EX: Estilo de Ejecución - Escarcha Pesada).", tags: ["Hielo"] },
                    { type: "Habilidad Adicional", name: "Habilidad Adicional: Beber Hielo", description: "Se activa cuando existe otro personaje de (Anomalía) o personaje de (Soporte) en el equipo: Al activar la (Técnica Especial EX), la eficiencia de acumulación de atributo hielo de Promeia aumenta un 30% con una duración de 30 segundos, al activarse repetidamente reinicia el tiempo de duración; Cuando cualquier personaje del equipo aplica el efecto (Congelación) a un enemigo, la duración de dicho efecto aumenta en 3 segundos; Cuando la (Técnica Especial EX) de Promeia golpea a un enemigo, el enemigo obtiene el estado de (Presunción de Culpabilidad), cuando los personajes de todo el equipo causan el efecto (Abloom) a un enemigo en estado de (Presunción de Culpabilidad) ignoran un 40% de defensa, el estado de (Presunción de Culpabilidad) dura 30 segundos, al activarse repetidamente reinicia el tiempo de duración.", tags: ["Hielo"] },
                    { type: "Mindscape 1", name: "Ideal Inocente", description: "Al activar Promeia la (Técnica Definitiva) obtiene un efecto adicional: si (Castigo de Escarcha) no está lleno obtiene 1 punto de (Castigo de Escarcha), este efecto se puede activar una vez tras activar la (Técnica Definitiva); cuando los personajes de todo el equipo causan el efecto (Abloom) a un enemigo en estado de (Presunción de Culpabilidad) ignoran adicionalmente un 15% de defensa." },
                    { type: "Mindscape 2", name: "Fe Tambaleante", description: "La Maestría de Anomalía de Promeia aumenta 60 puntos; el multiplicador del efecto (Abloom) causado al consumir (Castigo de Escarcha) aumenta un 165%." },
                    { type: "Mindscape 3", name: "Luna Cruel", description: "Ataque Básico, Evasión, Asistencia, Técnica Especial, Ataque en Cadena nivel de habilidad +2", tags: ["Electrico"] },
                    { type: "Mindscape 4", name: "Acusación Cruel", description: "Cuando Promeia activa el efecto (Abloom), recupera 5 puntos de (Erosión de Frío), en 0.5 segundos se activa como máximo una vez." },
                    { type: "Mindscape 5", name: "Polilla Moribunda", description: "Ataque Básico, Evasión, Asistencia, Técnica Especial, Ataque en Cadena nivel de habilidad +2", tags: ["Electrico"] },
                    { type: "Mindscape 6", name: "La Historia Continuará...", description: "Cuando Promeia consume (Castigo de Escarcha) para activar el efecto (Abloom), activa adicionalmente una vez un efecto (Abloom) especial, calculando de forma fija el 200% del multiplicador de daño de Anomalía de Atributo correspondiente, al mismo tiempo recupera 5 puntos de (Erosión de Frío), 100 puntos de decibelios, este efecto se activa como máximo una vez cada 15 segundos; además, el daño de Anomalía de Atributo, daño de (Desorden) causado por Promeia ignora un 15% de la Resistencia a todos los atributos del enemigo." }
                ],
            }
        }
    },
        ...
        versions: {
            "v2.8.1": {
                ...
                hotfixes: [
                    ...
                    },
                    {
                        ...
                        skills: [
                            { type: "Técnica Especial", name: "Técnica Especial EX: Aplastamiento de Motocicleta", description: "Cuando la energía es suficiente y la Vida actual no es inferior al 10% de la Vida Máxima, mantener pulsado [Icono Especial EX] para activar: Usa la motocicleta para aplastar hacia abajo, infligiendo Daño Físico; Al activar el movimiento entra en (Estado de Motocicleta), al terminar el movimiento entra en (Estado Libre) y recupera Vida equivalente al 20% de su Vida Máxima; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                            { type: "Técnica Especial", name: "Técnica Especial EX: Patada Voladora de Caballero", description: "Cuando el (Valor Térmico) está lleno, la energía es suficiente, y la Vida actual no es inferior al 10% de la Vida Máxima, mantener pulsado [Icono Especial EX] para activar: Salta de la motocicleta y patea al enemigo, infligiendo una gran cantidad de Daño Físico; Al activar el movimiento entra en (Estado de Motocicleta), al terminar el movimiento entra en (Estado Libre) y recupera Vida equivalente al 20% de su Vida Máxima; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                            { type: "Pasiva Central", name: "Pasiva Central: Determinación de Caballero", description: "Starlight - Billy aumentará adicionalmente su Fuerza Bruta según su Vida Máxima, cada 1 punto de Vida Máxima aumentará 0.1 puntos de Fuerza Bruta; El daño causado por los movimientos de Starlight - Billy que infligen Daño Físico es todo daño de Fuerza Bruta, ignorando la defensa del enemigo, y utiliza la Fuerza Bruta como multiplicador de daño del movimiento; cuando Starlight - Billy entra al campo de batalla recupera inmediatamente 60 puntos de energía de destello, en el modo de exploración este efecto se activa como máximo una vez cada 180 segundos; Cuando Starlight - Billy recibe daño letal, es inmune a ese daño y obtiene un escudo equivalente al 10% de su Vida Máxima, con una duración de 3 segundos, en 30 segundos se activa como máximo una vez, el daño recibido en un solo golpe no excederá el valor del escudo; Mientras Starlight - Billy se encuentra en (Estado de Motocicleta) consumirá Vida continuamente, su Daño Crítico aumenta un {VALOR_1}, el daño recibido se reduce un 40%, y su nivel de resistencia a la interrupción aumenta; En (Estado de Motocicleta), cuando la Vida de Starlight - Billy cae por debajo del 1% de su Vida Máxima, Starlight - Billy entrará en (Estado Libre); En (Estado de Motocicleta), cuando los movimientos causan daño recuperará (Valor Térmico), el límite máximo de (Valor Térmico) es de 100 puntos; cuando el (Valor Térmico) está lleno, la siguiente (Técnica Especial EX) se actualiza a (Técnica Especial EX: Patada Voladora de Caballero), al activar la (Técnica Especial EX: Patada Voladora de Caballero), consume todo el (Valor Térmico); Mientras Starlight - Billy se encuentra en (Forma Libre), cuando algunos de sus movimientos causan daño recuperará su propia Vida, cuando la Vida actual de Starlight - Billy no sea inferior al 10%, puede activar la (Técnica Especial: Subir al Vehículo) para entrar en (Forma de Motocicleta); Al activar la (Técnica Especial EX: Aplastamiento de Motocicleta) o al activar la (Técnica Especial: Cambiar a Forma Libre) / (Técnica Especial: Cambiar a Forma de Motocicleta) y desencadenar una (Evasión Perfecta), recuperará su propia Vida; Al activar el (Ataque Básico: Embestida de Motocicleta), (Ataque Básico: Latigazo de Motocicleta) y (Contraataque de Evasión: Levantamiento de Motocicleta) obtendrá un escudo equivalente al 3% de su Vida Máxima, el escudo se puede acumular hasta un máximo de 10 capas, dura 30 segundos, al activarse de nuevo se reinicia la duración." },
                            { type: "Habilidad Adicional", name: "", description: "Se activa cuando existe un personaje de (Aturdimiento), (Defensa) o (Soporte) en el equipo: Cuando el cuarto golpe del (Ataque Básico: Ataque de Luz Estelar), el (Contraataque de Evasión: Cañón de Mano) o el (Ataque en Cadena: Cañón Térmico de Luz Estelar) causan daño, obtiene una capa de (Mejora de Daño buff), con una duración de 20 segundos, acumulable hasta un máximo de 2 capas, cada capa de (Mejora de Daño buff) hará que el daño causado por el (Ataque en Cadena), la (Técnica Definitiva), la (Técnica Especial EX: Patada Voladora de Caballero) y el (Contraataque de Evasión: Levantamiento de Motocicleta) aumente un 15%." }
                        ]
                    }
                ]
            },
            "v2.8.2": {
                ...
                skills: [
                    ...
                    { type: "Técnica Especial", name: "Técnica Especial EX: Levantamiento de Motocicleta", description: "En la (Técnica Especial: Embestida de Motocicleta) al activar un bloqueo se activa automáticamente: Levanta la motocicleta para lanzar al enemigo por los aires, infligiendo Daño Físico; Tras lanzar el movimiento, si la energía es suficiente, pulsar [Icono Ataque] permite conectar con el (Contraataque de Evasión: Cañón de Mano)." },
                    ...
                    { type: "Pasiva Central", name: "Pasiva Central: Determinación de Caballero", description: "Starlight - Billy aumentará adicionalmente su Fuerza Bruta según su Vida Máxima, cada 1 punto de Vida Máxima aumentará 0.1 puntos de Fuerza Bruta; El daño causado por los movimientos de Starlight - Billy que infligen Daño Físico es todo daño de Fuerza Bruta, ignorando la defensa del enemigo, y utiliza la Fuerza Bruta como multiplicador de daño del movimiento; cuando Starlight - Billy entra al campo de batalla recupera inmediatamente 180 puntos de energía de destello, en el modo de exploración este efecto se activa como máximo una vez cada 20 segundos; Cuando la Vida es mayor al 30%, se puede pulsar [Icono Especial EX] para activar la (Técnica Especial: Embestida de Motocicleta), y cada vez que se activa este movimiento su propio Daño Crítico aumenta un 0.12%, con una duración de 58 segundos; Cuando los ataques de Starlight - Billy golpean a un enemigo, obtendrá (Valor Térmico), la cantidad de recuperación varía según el movimiento, el límite máximo de (Valor Térmico) es de 120 puntos, al estar en estado de combate, recuperará (Valor Térmico) lentamente; al activar (Evasión Perfecta), activar (Asistencia Defensiva: Escudo de Vehículo) o al activar un bloqueo, recuperará (Valor Térmico) adicional. Cuando el (Valor Térmico) supera los 100 puntos, mantener pulsado [Icono Especial EX] consumirá 100 puntos de (Valor Térmico), activando con prioridad la (Técnica Especial EX: Patada Voladora de Caballero); Después de que el cuarto golpe del (Ataque Básico: Ataque de Luz Estelar) golpea a un enemigo, recupera -20% de Vida; tras activar la (Técnica Especial EX: Aplastamiento de Motocicleta), recupera 3% de Vida; tras activar la (Técnica Especial EX: Patada Voladora de Caballero), recupera 10% de Vida." },
            ...
            "v2.8.3": {
                ...
                skills: [
                    { type: "Ataque Básico", name: "Ataque Básico: Caballero de Combate", description: "Pulsar [Icono Ataque] para activar: Realiza hasta cuatro ataques hacia adelante, infligiendo Daño Físico; Al activar el cuarto golpe del (Ataque Básico), pulsar [Icono Especial] permite activar rápidamente la (Técnica Especial: Presión de Potencia) y el consumo de Vida se reduce un 50%; Cuando el movimiento golpea a un enemigo, recupera una pequeña cantidad de Vida." },
                    { type: "Ataque Básico", name: "Ataque Cargado: Máxima Potencia Luz Estelar", description: "Cuando posee suficiente (Decisión), mantener pulsado [Icono Especial EX] para activar: Lanza una carga de motocicleta hacia adelante, y tras finalizar la carga desata un rayo láser, infligiendo una gran cantidad de Daño Físico; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                    { type: "Evasión", name: "Evasión: ¡Qué Sorpresa!", description: "Pulsar [Icono Dodges] para activar: Una esquiva rápida de carrera; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                    { type: "Evasión", name: "Evasión: ¡Derrape!", description: "Durante la (Técnica Especial: Presión de Potencia), arrastrar el joystick o pulsar [Icono Dodges] para activar: Controla la motocicleta para derrapar, en un corto periodo de tiempo puede activar (Evasión Perfecta); Si activa con éxito una (Evasión Perfecta), conectará inmediatamente con el (Contraataque de Evasión: Torbellino de Llamas); Durante la ejecución del movimiento, mantendrá el conteo de tiempo de la (Técnica Especial: Presión de Potencia), y al alcanzar el tiempo máximo, conectará automáticamente con la (Técnica Especial EX: Técnica de Rueda Loca); Si se interrumpe el movimiento antes de tiempo, conectará automáticamente con la (Técnica Especial: Fuera de Control); Posee un breve efecto de invencibilidad durante la ejecución del movimiento." },
                    { type: "Evasión", name: "Evasión: Patrulla de Caballero", description: "Mantener pulsado [Icono Dodges] mientras arrastras el joystick: Entra en un estado de movimiento a alta velocidad, usa el joystick para controlar la dirección, al soltarlo se detendrá; Al activarse, puede activar (Evasión Perfecta) por un corto periodo de tiempo." },
                    { type: "Evasión", name: "Ataque de Carrera: Estrella - Símbolo - Castigo", description: "Pulsar [Icono Ataque] para activar: Realiza un corte rápido hacia adelante, infligiendo Daño Físico." },
                    { type: "Evasión", name: "Contraataque de Evasión: Rey del Duelo", description: "Tras activar una (Evasión Perfecta), pulsar [Icono Ataque] para activar: Dispara un cañón de mano hacia adelante, infligiendo Daño Físico; Si ha activado una (Evasión Perfecta), tras lanzar este movimiento se puede conectar con el cuarto golpe del (Ataque Básico); Cuando el movimiento golpea a un enemigo, recupera una pequeña cantidad de Vida; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                    { type: "Evasión", name: "Contraataque de Evasión: Torbellino de Llamas", description: "Se activa automáticamente al activar una (Evasión Perfecta) durante (Evasión: ¡Derrape!): Gira la motocicleta para infligir Daño Físico a los enemigos circundantes; Tras lanzar el movimiento, conecta automáticamente con la (Técnica Especial EX: Técnica de Rueda Loca); Posee efecto de invencibilidad durante la ejecución del movimiento." },
                    { type: "Técnica Especial", name: "Técnica Especial: Presión de Potencia", description: "Cuando su propia Vida es mayor al 20%, pulsar [Icono Especial] para activar: Basado en su Vida Máxima, consume un 16% de Vida para invocar la motocicleta y chocar rápidamente contra el enemigo, infligiendo Daño Físico de forma continua; Durante un breve periodo al iniciar el movimiento, si recibe un ataque enemigo, activará un bloqueo, será inmune a ese ataque y recuperará 5 puntos de (Decisión); Al activar el bloqueo, conectará inmediatamente con la (Técnica Especial EX: Técnica de Rueda Loca); Tras atacar continuamente por un tiempo, conectará automáticamente con la (Técnica Especial EX: Técnica de Rueda Loca)." },
                    { type: "Técnica Especial", name: "Técnica Especial: Fuera de Control", description: "Se activa automáticamente al interrumpir la (Evasión: ¡Derrape!): Patea la motocicleta hacia el enemigo, infligiendo Daño Físico; Tras lanzar el movimiento, se puede conectar con el (Contraataque de Evasión: Rey del Duelo)." },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Técnica de Rueda Loca", description: "Se activa automáticamente al alcanzar el tiempo máximo de ataque de (Técnica Especial: Presión de Potencia) o al activar un bloqueo: Levanta la motocicleta para atacar al enemigo, infligiendo Daño Físico; Cuando el movimiento golpea a un enemigo, recupera 15 puntos adicionales de (Decisión); Tras lanzar el movimiento, si la energía es suficiente, pulsar [Icono Especial EX] permite conectar con la (Técnica Especial EX: Paso de Balanceo); Al terminar la acción del movimiento, conecta automáticamente con la (Técnica Especial: Fuera de Control)." },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Agarre de Rueda", description: "Cuando la energía es suficiente, mantener pulsado [Icono Especial EX] para activar: Usa la motocicleta para aplastar hacia abajo, infligiendo Daño Físico; Tras lanzar el movimiento, recupera un 20% de su Vida Máxima; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Paso de Balanceo", description: "Tras activar la (Técnica Especial EX: Técnica de Rueda Loca), si la energía es suficiente, pulsar [Icono Especial EX] para activar: Usa la motocicleta y el cañón de mano para realizar un ataque combinado, infligiendo Daño Físico; Al activar el movimiento, recupera un 20% de su Vida Máxima; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                    { type: "Asistencia", name: "Asistencia Rápida: Estrella - Poder del Vínculo", description: "Cuando el personaje actualmente en uso es lanzado por los aires, pulsar [Icono Assist] para activar: Dispara un cañón de mano hacia adelante, infligiendo Daño Físico; Cuando la Vida es suficiente, activar este movimiento cambiará a activar la (Técnica Especial: Presión de Potencia), este efecto se activa como máximo 1 vez cada 5 segundos; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                    { type: "Asistencia", name: "Asistencia Defensiva: Escenario Heroico", description: "Cuando el personaje de vanguardia está a punto de ser atacado, pulsar [Icono Assist] para activar: Realiza una parada al ataque enemigo, acumulando una gran cantidad de valor de Aturdimiento; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                    { type: "Asistencia", name: "Ataque de Asistencia: Salida del Villano", description: "Tras activar (Asistencia Defensiva), pulsar [Icono Ataque] para activar: Lanza un ataque de patada de motocicleta sobre el objetivo, infligiendo una gran cantidad de Daño Físico; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                    { type: "Técnica Definitiva", name: "Ataque en Cadena: Paseo de Caballero", description: "Al activar un (Ataque en Cadena), seleccionar al personaje correspondiente para activar: Realiza un ataque de múltiples golpes hacia adelante, infligiendo una gran cantidad de Daño Físico; Al activarse el movimiento, recupera 20 puntos de (Decisión); Posee efecto de invencibilidad durante la ejecución del movimiento." },
                    { type: "Técnica Definitiva", name: "Técnica Definitiva: Patada Voladora de Caballero", description: "Cuando el nivel de decibelios llega a (Máximo), pulsar [Icono Definitiva] para activar: Salta por los aires hacia el objetivo y lanza una patada voladora, infligiendo una gran cantidad de Daño Físico; Al activarse el movimiento, recupera un 20% de su Vida Máxima; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                    { type: "Pasiva Central", name: "Pasiva Central: Determinación de Caballero", description: "Starlight - Billy aumentará adicionalmente su Fuerza Bruta según su Vida Máxima, cada 1 punto de Vida Máxima aumentará 0.1 puntos de Fuerza Bruta; El daño causado por los movimientos de Starlight - Billy que infligen Daño Físico es todo daño de Fuerza Bruta, ignorando la defensa del enemigo, y utiliza la Fuerza Bruta como multiplicador de daño del movimiento; cuando Starlight - Billy entra al campo de batalla recupera inmediatamente 60 puntos de energía de destello, en el modo de exploración este efecto se activa como máximo una vez cada 180 segundos; Cuando la Vida es mayor al 20%, se puede pulsar [Icono Especial] consumiendo Vida para activar la (Técnica Especial: Presión de Potencia), y mientras se encuentra en (Estado de Motocicleta), cada vez que se activa un movimiento, su propio Daño Crítico aumenta un {VALOR_1}, con una duración de 30 segundos, al activarse de nuevo se reinicia la duración; Cuando los ataques de Starlight - Billy golpean a un enemigo, obtendrá (Decisión), la cantidad de recuperación varía según el movimiento, el límite máximo de (Decisión) es de 120 puntos, al estar en estado de combate, recuperará (Decisión) lentamente; Al activar la (Técnica Especial EX: Técnica de Rueda Loca), el (Ataque en Cadena: Paseo de Caballero) o al activar un bloqueo, recuperará (Decisión) adicional; al activar una (Evasión Perfecta) de cualquier forma, recuperará 6 puntos de (Decisión); Cuando la (Decisión) supera los 100 puntos, mantener pulsado [Icono Ataque] consumirá 100 puntos de (Decisión) para activar el (Ataque Básico: Máxima Potencia Luz Estelar); Después de que el cuarto golpe del (Ataque Básico: Caballero de Combate) o el (Contraataque de Evasión: Rey del Duelo) golpean a un enemigo, recupera una pequeña cantidad de Vida; tras activar la (Técnica Especial EX: Agarre de Rueda), la (Técnica Especial EX: Paso de Balanceo) o la (Técnica Definitiva: Patada Voladora de Caballero), recupera Vida." },
                    { type: "Habilidad Adicional", name: "Habilidad Adicional: Luz Estelar Abrasadora", description: "Se activa cuando existe un personaje de (Aturdimiento), (Defensa) o (Soporte) en el equipo: Cuando la (Técnica Especial EX: Técnica de Rueda Loca), el cuarto golpe del (Ataque Básico: Caballero de Combate), el (Ataque en Cadena: Paseo de Caballero) o la (Técnica Definitiva: Patada Voladora de Caballero) causan daño, obtiene una capa de (Luz Estelar), con una duración de 30 segundos, acumulable hasta un máximo de 2 capas, cada capa de (Luz Estelar) hará que el daño causado por el (Ataque en Cadena), la (Técnica Definitiva), la (Técnica Especial EX) y el (Ataque Básico: Máxima Potencia Luz Estelar) aumente un 20%." },
                    { type: "Mindscape 1", name: "Entrada del Héroe", description: "Al entrar al campo de batalla, la (Pasiva Núcleo: Determinación de Caballero) recupera 60 puntos adicionales de energía de destello; tras golpear a un enemigo con la (Técnica Definitiva: Patada Voladora de Caballero), obtiene 25 puntos de (Decisión); cuando la (Técnica Especial EX) golpea a un enemigo, el daño infligido por el portador ignora un 20% de la Resistencia Física del objetivo durante 30 segundos, al activarse de nuevo se reinicia la duración." },
                    { type: "Mindscape 2", name: "Mecano de la Tierra Baldía", description: "El daño infligido por el (Ataque Básico: Máxima Potencia Luz Estelar) y la (Técnica Definitiva: Patada Voladora de Caballero) aumenta un 24%; al activar la (Técnica Especial EX: Paso de Balanceo), obtiene el efecto (Turbocompresor): el tiempo de ataque requerido para la (Técnica Especial: Presión de Potencia) se reduce un 75%, al activar la (Técnica Especial EX: Técnica de Rueda Loca) consume este efecto para aumentar el daño de dicho movimiento en un 36%; tras activar la (Técnica Especial: Presión de Potencia) y golpear a un enemigo aturdido, conectará directamente con la (Técnica Especial EX: Técnica de Rueda Loca)." },
                    { type: "Mindscape 3", name: "Espíritu de Caballero", description: "Nivel de Ataque Básico, Evasión, Asistencia, Técnica Especial y Ataque en Cadena +2", tags: ["Electrico"] },
                    { type: "Mindscape 4", name: "Fulminante de Juicio", description: "En estado de combate, cada vez que activa la (Técnica Especial: Presión de Potencia), su propio Daño Crítico aumenta un 12%, acumulable hasta un máximo de 2 capas, con una duración de 30 segundos, al activarse de nuevo se reinicia la duración; si la Vida es inferior al 40% y el personaje se encuentra en la retaguardia (no está en uso), recuperará Vida continuamente hasta alcanzar el 40%." },
                    { type: "Mindscape 5", name: "Armamento Resplandeciente", description: "Nivel de Ataque Básico, Evasión, Asistencia, Técnica Especial y Ataque en Cadena +2", tags: ["Electrico"] },
                    { type: "Mindscape 6", name: "Caballero de Luz Estelar", description: "Tras golpear a un enemigo con el cuarto golpe del (Ataque Básico: Caballero de Combate), la (Técnica Especial EX: Técnica de Rueda Loca) o el (Ataque en Cadena: Paseo de Caballero), puede obtener 1 capa de (Resplandor Estelar), acumulable hasta un máximo de 6 capas, se puede obtener como máximo 1 capa por cada movimiento; al activar la (Técnica Definitiva: Patada Voladora de Caballero) o el (Ataque Básico: Máxima Potencia Luz Estelar), consume hasta 3 capas de (Resplandor Estelar), por cada capa consumida el Daño de Fuerza Bruta de dicho movimiento aumenta un 5%, y el último golpe inflige un daño de Fuerza Bruta adicional equivalente al 140% de la Fuerza Bruta." },
                ],
                hotfixes: [
                    {
                        id: 1,
                        ...
                        skills: [
                            { type: "Ataque Básico", name: "Ataque Básico: Caballero de Combate", description: "Pulsar [Icono Ataque] para activar: Realiza hasta cuatro ataques hacia adelante, infligiendo Daño Físico; Al activar el cuarto golpe, pulsar [Icono Especial] para activar la (Técnica Especial: Presión de Potencia) el consumo de vida se reduce un 50%; Cuando el movimiento golpea a un enemigo, recupera una pequeña cantidad de vida." },
                            { type: "Ataque Básico", name: "Ataque Cargado: Máxima Potencia Luz Estelar", description: "Cuando (Decisión) es suficiente, mantener pulsado [Icono Ataque] para activar: Lanza una carga de motocicleta hacia adelante, tras finalizar la carga desata un rayo láser, infligiendo una gran cantidad de Daño Físico; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                            { type: "Técnica Especial", name: "Técnica Especial: Presión de Potencia", description: "Cuando su propia vida es mayor al 20%, pulsar [Icono Especial] para activar: Basado en la vida máxima, consume 16% de vida, invoca la motocicleta para chocar rápidamente contra el enemigo, infligiendo continuamente Daño Físico; Al activar el movimiento en un corto periodo de tiempo de la activación del movimiento, si recibe un ataque enemigo, activará un bloqueo, será inmune a ese ataque, y recuperará 5 puntos de (Decisión); Tras activar el bloqueo, conectará inmediatamente con la (Técnica Especial EX: Técnica de Rueda Loca); Tras mantener el ataque del movimiento por un periodo de tiempo conectará automáticamente con la (Técnica Especial EX: Técnica de Rueda Loca)." },
                            { type: "Técnica Especial", name: "Técnica Especial: Fuera de Control", description: "Al interrumpir (Evasión: ¡Derrape!) se activa automáticamente: Patea la motocicleta hacia el enemigo, infligiendo Daño Físico; Tras lanzar el movimiento, se puede conectar con el (Contraataque de Evasión: Rey del Duelo)." },
                            { type: "Técnica Especial", name: "Técnica Especial EX: Técnica de Rueda Loca", description: "Al alcanzar el tiempo máximo de ataque de (Técnica Especial: Presión de Potencia) o al activar un bloqueo se activa automáticamente: Levanta la motocicleta para atacar al enemigo, infligiendo Daño Físico; Tras golpear a un enemigo con el movimiento, recupera adicionalmente 10 puntos de (Decisión); Tras lanzar el movimiento, si la energía es suficiente, pulsar [Icono Especial R] permite conectar con la (Técnica Especial EX: Paso de Balanceo); Tras finalizar la acción del movimiento, conecta automáticamente con la (Técnica Especial: Fuera de Control); Posee efecto de invencibilidad durante la ejecución del movimiento." },
                            { type: "Técnica Especial", name: "Técnica Especial EX: Agarre de Rueda", description: "Cuando la energía es suficiente, mantener pulsado [Icono Especial R] para activar: Usa la motocicleta para aplastar hacia abajo, infligiendo Daño Físico; Tras lanzar el movimiento, recupera un 20% de su Vida Máxima; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                            { type: "Técnica Especial", name: "Técnica Especial EX: Paso de Balanceo", description: "Tras activar la (Técnica Especial EX: Técnica de Rueda Loca), si la energía es suficiente, pulsar o mantener pulsado [Icono Especial R] para activar: Usa la motocicleta y el cañón de mano para realizar un ataque combinado, infligiendo Daño Físico; Al activar el movimiento, recupera un 20% de su Vida Máxima; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                            { type: "Evasión", name: "Evasión: ¡Qué Sorpresa!", description: "Pulsar [Icono Dodges] para activar: Una esquiva rápida de carrera; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                            { type: "Evasión", name: "Evasión: ¡Derrape!", description: "Durante la (Técnica Especial: Presión de Potencia) arrastrar el joystick o pulsar [Icono Dodges] para activar: Controla la motocicleta para derrapar, en un corto periodo de tiempo puede activar (Evasión Perfecta); Si activa con éxito una (Evasión Perfecta), conectará inmediatamente con el (Contraataque de Evasión: Torbellino de Llamas); Durante la ejecución del movimiento, mantendrá el conteo de tiempo de la (Técnica Especial: Presión de Potencia), y al alcanzar el tiempo máximo, conectará automáticamente con la (Técnica Especial EX: Técnica de Rueda Loca); Si se interrumpe el movimiento antes de tiempo, conectará automáticamente con la (Técnica Especial: Fuera de Control); Posee un breve efecto de invencibilidad durante la ejecución del movimiento." },
                            { type: "Evasión", name: "Evasión: Patrulla de Caballero", description: "Mantener pulsado [Icono Dodges] mientras arrastras el joystick: Entra en un estado de movimiento a alta velocidad, usa el joystick para controlar la dirección, al soltarlo se detendrá; Al activarse, puede activar (Evasión Perfecta) por un corto periodo de tiempo." },
                            { type: "Evasión", name: "Ataque de Carrera: Estrella - Símbolo - Castigo", description: "Al evadir, pulsar [Icono Ataque] para activar: Realiza un corte rápido hacia adelante, infligiendo Daño Físico." },
                            { type: "Evasión", name: "Contraataque de Evasión: Rey del Duelo", description: "Tras activar una (Evasión Perfecta), pulsar [Icono Ataque] para activar: Dispara un cañón de mano hacia adelante, infligiendo Daño Físico; Si ha activado una (Evasión Perfecta), tras lanzar este movimiento se puede conectar con el cuarto golpe del (Ataque Básico); Cuando el movimiento golpea a un enemigo, recupera una pequeña cantidad de Vida; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                            { type: "Evasión", name: "Contraataque de Evasión: Torbellino de Llamas", description: "Se activa automáticamente al activar una (Evasión Perfecta) durante (Evasión: ¡Derrape!): Gira la motocicleta para infligir Daño Físico a los enemigos circundantes; Tras lanzar el movimiento, conecta automáticamente con la (Técnica Especial EX: Técnica de Rueda Loca); Posee efecto de invencibilidad durante la ejecución del movimiento." },
                            { type: "Asistencia", name: "Asistencia Rápida: Estrella - Poder del Vínculo", description: "Cuando el personaje actualmente en uso es lanzado por los aires, pulsar [Icono Assist] para activar: Dispara un cañón de mano hacia adelante, infligiendo Daño Físico; Cuando la Vida es mayor al 20%, activar este movimiento cambiará a activar la (Técnica Especial: Presión de Potencia), este efecto se activa como máximo 1 vez cada 5 segundos; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                            { type: "Asistencia", name: "Asistencia Defensiva: Escenario Heroico", description: "Cuando el personaje de vanguardia está a punto de ser atacado, pulsar [Icono Assist] para activar: Realiza una parada al ataque enemigo, acumulando una gran cantidad de valor de Aturdimiento; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                            { type: "Asistencia", name: "Ataque de Asistencia: Salida del Villano", description: "Tras activar (Asistencia Defensiva), pulsar [Icono Ataque] para activar: Lanza un ataque de patada de motocicleta sobre el objetivo, infligiendo una gran cantidad de Daño Físico; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                            { type: "Técnica Definitiva", name: "Ataque en Cadena: Paseo de Caballero", description: "Al activar un (Ataque en Cadena), seleccionar al personaje correspondiente para activar: Realiza un ataque de múltiples golpes hacia adelante, infligiendo una gran cantidad de Daño Físico; Al activarse el movimiento, recupera 15 puntos de (Decisión); Posee efecto de invencibilidad durante la ejecución del movimiento." },
                            { type: "Técnica Definitiva", name: "Técnica Definitiva: Patada Voladora de Caballero", description: "Cuando el nivel de decibelios llega a (Máximo), pulsar [Icono Definitiva] para activar: Salta por los aires hacia el objetivo y lanza una patada voladora, infligiendo una gran cantidad de Daño Físico; Al activarse el movimiento, recupera un 0% de su Vida Máxima; Posee efecto de invencibilidad durante la ejecución del movimiento." },
                            { type: "Pasiva Central", name: "Pasiva Central: Determinación de Caballero", description: "Starlight - Billy aumentará adicionalmente su (Fuerza Bruta) según su Vida Máxima, cada 1 punto de Vida Máxima aumentará 0.1 puntos de (Fuerza Bruta); El daño causado por los movimientos de Starlight - Billy que infligen Daño Físico es todo daño de Fuerza Bruta, ignorando la defensa del enemigo, y utiliza la (Fuerza Bruta) como multiplicador de daño del movimiento; cuando Starlight - Billy entra al campo de batalla recupera inmediatamente 60 puntos de energía de destello, en el modo de exploración este efecto se activa como máximo una vez cada 180 segundos; Cuando la Vida es mayor al 20%, se puede pulsar [Icono Especial R] consumiendo Vida para activar la (Técnica Especial: Presión de Potencia), y mientras se encuentra en estado de combate, cada vez que se activa un movimiento, su propio Daño Crítico aumenta un {VALOR_1}, con una duración de 30 segundos, al activarse de nuevo se reinicia la duración; Cuando los ataques de Starlight - Billy golpean a un enemigo, obtendrá (Decisión), el límite máximo de (Decisión) es de 120 puntos, al estar en estado de combate, recuperará (Decisión) lentamente; Al activar la (Técnica Especial EX: Técnica de Rueda Loca), el (Ataque en Cadena: Paseo de Caballero) o al activar un bloqueo, recuperará (Decisión) adicional; al activar una (Evasión Perfecta) de cualquier forma, recuperará 6 puntos de (Decisión); Cuando la (Decisión) supera los 100 puntos, mantener pulsado [Icono Ataque] consumirá 100 puntos de (Decisión) para activar el (Ataque Básico: Máxima Potencia Luz Estelar); Después de que el cuarto golpe del (Ataque Básico: Caballero de Combate) o el (Contraataque de Evasión: Rey del Duelo) golpean a un enemigo, recupera una pequeña cantidad de Vida; tras activar la (Técnica Especial EX: Agarre de Rueda), la (Técnica Especial EX: Paso de Balanceo) o la (Técnica Definitiva: Patada Voladora de Caballero), recupera Vida." },
                            { type: "Habilidad Adicional", name: "Habilidad Adicional: Luz Estelar Abrasadora", description: "Se activa cuando existe un personaje de (Aturdimiento), (Defensa) o (Soporte) en el equipo: Cuando la (Técnica Especial EX: Técnica de Rueda Loca), el cuarto golpe del (Ataque Básico: Caballero de Combate), el (Ataque en Cadena: Paseo de Caballero) o la (Técnica Definitiva: Patada Voladora de Caballero) causan daño, obtiene una capa de (Luz Estelar), con una duración de 30 segundos, acumulable hasta un máximo de 2 capas, cada capa de (Luz Estelar) hará que el daño causado por el (Ataque en Cadena), la (Técnica Definitiva), la (Técnica Especial EX) y el (Ataque Básico: Máxima Potencia Luz Estelar) aumente un 20%." },
                            { type: "Mindscape 1", name: "Entrada del Héroe", description: "Al entrar al campo de batalla, (Determinación de Caballero) recupera 60 puntos adicionales de energía de destello; tras golpear a un enemigo con la (Técnica Definitiva: Patada Voladora de Caballero), obtiene 25 puntos de (Decisión); cuando la (Técnica Especial EX) golpea a un enemigo, el daño infligido por el portador ignora un 20% de la Resistencia Física del objetivo durante 30 segundos, al activarse de nuevo se reinicia la duración." },
                            { type: "Mindscape 2", name: "Mecano de la Tierra Baldía", description: "El daño infligido por el (Ataque Básico: Máxima Potencia Luz Estelar) y la (Técnica Definitiva: Patada Voladora de Caballero) aumenta un 24%; al activar la (Técnica Especial EX: Paso de Balanceo), obtiene el efecto (Turbocompresor): el tiempo de ataque requerido para la (Técnica Especial: Presión de Potencia) se reduce un 75%, al activar la (Técnica Especial EX: Técnica de Rueda Loca) consume este efecto para aumentar el daño de dicho movimiento en un 36%; tras activar la (Técnica Especial: Presión de Potencia) y golpear a un enemigo aturdido, conectará directamente con la (Técnica Especial EX: Técnica de Rueda Loca)." },
                            { type: "Mindscape 3", name: "Espíritu de Caballero", description: "Nivel de habilidad de Ataque Básico, Evasión, Técnica de Asistencia, Técnica Especial, Ataque en Cadena +2", tags: ["Electrico"] },
                            { type: "Mindscape 4", name: "Fulminante de Juicio", description: "En estado de combate, cada vez que activa la (Técnica Especial: Presión de Potencia), su propio Daño Crítico aumenta un 12%, acumulable hasta un máximo de 2 capas, con una duración de 30 segundos, al activarse de nuevo se reinicia la duración; si la Vida es inferior al 40% y el personaje se encuentra en la retaguardia, recuperará Vida continuamente hasta alcanzar el 40%." },
                            { type: "Mindscape 5", name: "Armamento Resplandeciente", description: "Nivel de habilidad de Ataque Básico, Evasión, Técnica de Asistencia, Técnica Especial, Ataque en Cadena +2", tags: ["Electrico"] },
                            { type: "Mindscape 6", name: "Caballero de Luz Estelar", description: "Tras golpear a un enemigo con el cuarto golpe del (Ataque Básico: Caballero de Combate), la (Técnica Especial EX: Técnica de Rueda Loca) o el (Ataque en Cadena: Paseo de Caballero), puede obtener 1 capa de (Resplandor Estelar), acumulable hasta un máximo de 6 capas, se puede obtener como máximo 1 capa por cada movimiento; al activar la (Técnica Definitiva: Patada Voladora de Caballero) o el (Ataque Básico: Máxima Potencia Luz Estelar), consume hasta 3 capas de (Resplandor Estelar), por cada capa consumida el Daño de Fuerza Bruta de dicho movimiento aumenta un 5%, y el último golpe inflige un daño de Fuerza Bruta adicional equivalente al 140% de la (Fuerza Bruta)." }
                        ]
                    }
                ]
        ...
        versions: {
            "v3.0.1": {
                ...
                skills: [
                    ...
                    { type: "Mindscape 1", name: "(Test1)", description: "Cuando la regeneración automática de energía inicial de Velina es mayor a 1, por cada 0.01 que exceda, la Tasa de Anomalía aumenta 0.7 puntos, aumentando adicionalmente como máximo 0.3 puntos; Cuando Velina entra al campo de batalla, obtiene 45 puntos de (Energía de Viento), en el modo de exploración este efecto se activa como máximo una vez cada 180 segundos, Velina al activar cualquier (Técnica Especial EX) obtendrá 45 puntos de (Energía de Viento), el límite de (Energía de Viento) es de 135 puntos; Cuando el tornado creado por Velina golpea a un enemigo en estado de (Impregnación), activará el efecto (Teñido), transformándose en un tornado del atributo correspondiente, y causará daño del atributo correspondiente; Cuando el ataque del tornado golpea a un enemigo, reducirá la resistencia a la acumulación de anomalía de atributo viento y la resistencia a la acumulación de anomalía del atributo correspondiente tras el (Teñido) del enemigo en un 10%, con una duración de 40 segundos, al activarse repetidamente reinicia el tiempo de duración; Cuando Velina activa (Turbulencia), invocará un (Pequeño Campo de Viento), infligiendo Daño Viento, cuando el (Pequeño Campo de Viento) y el (Gran Campo de Viento) explotan y golpean a un enemigo en estado de anomalía de atributo viento, ambos causarán al objetivo 1 vez un daño de (Abloom): calcula adicionalmente una vez el daño de anomalía de atributo, calculando de forma fija el 210% y el 300% del multiplicador de daño de anomalía de atributo viento respectivamente; Cuando Velina activa (Turbulencia), obtendrá 1 (Punto de Mejora), este efecto se activa como máximo una vez cada 3 segundos, cuando Velina posee 2 (Puntos de Mejora), la próxima vez que Velina active (Turbulencia), el multiplicador de daño de esa (Turbulencia) aumentará un 450%, y ya no invocará un (Pequeño Campo de Viento) sino que invocará un (Gran Campo de Viento). Al entrar al campo de batalla, Velina obtiene inmediatamente 30 puntos de energía, en el modo de exploración este efecto se activa como máximo una vez cada 180 segundos; Cuando Velina activa (Turbulencia) y (Corrosión), ignora un 15% de resistencia al daño de todos los atributos del objetivo." },
                    { type: "Mindscape 2", name: "(Test1) Plan de Saturación", description: "Cuando Velina activa (Corrosión), también puede obtener 1 (Punto de Mejora), este efecto se activa como máximo una vez cada 5 segundos; tras ser (Teñido) el (Gran Campo de Viento), este puede acumular valor continuo de anomalía del atributo correspondiente, y el valor de acumulación de anomalía de atributo acumulado por este ataque no participa en el cálculo de daño de anomalía." },
                    { type: "Mindscape 3", name: "(Test1) Conquista Ceremonial", description: "Nivel de habilidad de (Ataque Básico), (Evasión), (Técnica de Asistencia), (Técnica Especial), (Ataque en Cadena) +2." },
                    { type: "Mindscape 4", name: "(Test1) La Fiesta de Té es el Juicio", description: "El ataque de Velina aumenta un 10%; al activar (Visión Extrema) mediante (Técnica Especial EX: Cizalladura del Viento - Aclaramiento), recupera 1 (Punto de Asistencia)." },
                    { type: "Mindscape 5", name: "(Test1) Bruja Anunciadora de Muerte", description: "Nivel de habilidad de (Ataque Básico), (Evasión), (Técnica de Asistencia), (Técnica Especial), (Ataque en Cadena) +2." },
                    { type: "Mindscape 6", name: "(Test1) Ángel Principal", description: "Cuando el golpe pesado de (Ataque de Asistencia: Tácticas de Negociación) golpea a un enemigo en estado de anomalía de atributo viento, causará al objetivo 1 vez un daño de (Abloom): calcula adicionalmente una vez el daño de anomalía de atributo, calculando de forma fija el 60% del multiplicador de daño de anomalía de atributo viento; Cuando el ataque de Velina golpea a un enemigo en estado de anomalía de atributo viento, el valor de acumulación de anomalía causado aumenta un 20%; Cuando Velina vuelve a aplicar (Corrosión) a un enemigo en estado de (Corrosión), aumentará el daño de esta (Corrosión) basándose en el tiempo de duración restante de la (Corrosión) anterior, por cada 1 segundo de duración restante el daño aumentará un 2%." }
                ]
            }
        }
    }
