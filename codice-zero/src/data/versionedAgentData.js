        ...
        versions: {
            ...
            "v2.8.3": {
                ...
                skills: [
                    ...
                    { type: "Pasiva Central", name: "Pasiva Central: Fuego Robado", description: "Si el Control de Anomalía inicial de Promeia es mayor a 140 puntos, cada 1 punto que exceda aumentará su propia Maestría de Anomalía en 1.5 puntos, y aumenta un 0.32% el daño de (Descarga de Anomalía) infligido por todo el equipo; Al golpear a los enemigos con diferentes ataques, Promeia recupera una cierta cantidad de (Erosión de Frío), cuando un personaje del equipo activa (Congelación), (Desorden), (Turbulencia), o se activa la (Técnica Especial EX: Sombra Oculta), recupera adicionalmente 5/5/5/10 puntos de (Erosión de Frío), pudiendo acumular hasta un máximo de 100 puntos; Cuando el efecto (Descarga de Anomalía) activado por un compañero de equipo golpea a un enemigo, Promeia recupera adicionalmente 15 puntos de (Erosión de Frío), se activa como máximo una vez cada 0.1 segundos; Si la (Erosión de Frío) es mayor o igual a 50 puntos, consumirá 50 puntos, convirtiéndolos en 1 punto de (Castigo de Escarcha), pudiendo obtener hasta un máximo de 2 puntos; Al entrar al campo de batalla, Promeia obtiene 2 puntos de (Castigo de Escarcha); Al hacer que el golpe final de la (Técnica Especial: Veredicto) golpee a un enemigo en estado de Anomalía, consume 1 punto de (Castigo de Escarcha) para activar 1 vez (Descarga de Anomalía), calculando de forma fija el {VALOR_1} del multiplicador correspondiente; Cuando la (Descarga de Anomalía) propia golpea a un enemigo recupera adicionalmente 100 puntos de decibelios, en 0.5 segundos se activa como máximo una vez; cuando compañeros activan (Descarga de Anomalía) ella recupera 150 decibelios, se activa como máximo una vez cada 0.1 segundos; Al activar la (Técnica Definitiva: Castigo Perforahuesos) obtiene el efecto (Helada), al poseer este efecto, tras activar (Técnica Especial: Veredicto), (Ataque en Cadena: Liquidación Invertida) o (Técnica Definitiva) pulsar o mantener pulsado [Icono Especial] permite consumir el efecto (Helada) y conectar directamente con la (Técnica Especial EX: Escarcha Pesada).", tags: ["Hielo"] },
                    { type: "Habilidad Adicional", name: "Habilidad Adicional: Beber Hielo", description: "Se activa cuando existe otro personaje de (Anomalía) o (Soporte) en el equipo: Al activar la (Técnica Especial EX), la Eficiencia de Acumulación de Atributo Hielo de Promeia aumenta en un 30%, con una duración de 30 segundos, al activarse de nuevo se reinicia la duración; Cuando cualquier personaje del equipo aplica el efecto (Congelación) a un enemigo, la duración de dicho efecto aumenta en 3 segundos; Cuando la (Técnica Especial EX) de Promeia golpea a un enemigo, aplica (Presunción de Culpabilidad): todo el equipo ignora un 40% de defensa al infligir daño mediante (Descarga de Anomalía) a enemigos afectados.", tags: ["Hielo"] },
                    { type: "Mindscape 1", name: "Ideal Inocente", description: "Al usar (Definitiva), obtiene 1 punto de (Castigo de Escarcha) si no está al máximo; tras la (Definitiva), todo el equipo ignora un 15% de defensa contra enemigos en estado de (Presunción de Culpabilidad) al causar (Descarga de Anomalía)."},
                    { type: "Mindscape 2", name: "Fe Tambaleante", description: "La Maestría de Anomalía de Promeia aumenta 60 puntos; el multiplicador del efecto de (Descarga de Anomalía) causado al consumir (Castigo de Escarcha) aumenta un 165%."},
                    { type: "Mindscape 4", name: "Acusación Cruel", description: "Cuando Promeia activa el efecto (Descarga de Anomalía), recupera 5 puntos de (Erosión de Frío), se activa como máximo una vez cada 0.5 segundos."},
                    { type: "Mindscape 6", name: "Historia Continuará...", description: "Al consumir (Castigo de Escarcha) para activar (Descarga de Anomalía), activa adicionalmente una vez un efecto especial de (Descarga de Anomalía), calculando de forma fija un multiplicador del 200% del daño de Anomalía de Atributo correspondiente, y al mismo tiempo recupera 5 puntos de (Erosión de Frío) y 100 puntos de decibelios, este efecto se activa como máximo una vez cada 15 segundos; además, el daño de Anomalía de Atributo y el daño de (Desorden) infligido por Promeia ignora un 15% de la Resistencia a Todos los Atributos del enemigo."}
