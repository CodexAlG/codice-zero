        ...
        versions: {
            ...
            "v2.8.3": {
                ...
                skills: [
                    ...
                    { type: "Pasiva Central", name: "Pasiva Central: Fuego Robado", description: "Si la Tasa de Anomalía inicial de Promeia es mayor a 140 puntos, cada 1 punto que exceda aumentará su propia Maestría de Anomalía en 1.5 puntos, y aumenta un 0.32% el daño de (Abloom) infligido por todo el equipo; Al golpear a los enemigos con diferentes ataques, Promeia recupera una cierta cantidad de (Erosión de Frío), cuando un personaje del equipo activa (Congelación), (Desorden), (Turbulencia), o se activa la (Técnica Especial EX: Sombra Oculta), recupera adicionalmente 5/5/5/10 puntos de (Erosión de Frío), pudiendo acumular hasta un máximo de 100 puntos; Cuando el efecto (Abloom) activado por un compañero de equipo golpea a un enemigo, Promeia recupera adicionalmente 15 puntos de (Erosión de Frío), se activa como máximo una vez cada 0.1 segundos; Si la (Erosión de Frío) es mayor o igual a 50 puntos, consumirá 50 puntos, convirtiéndolos en 1 punto de (Castigo de Escarcha), pudiendo obtener hasta un máximo de 2 puntos; Al entrar al campo de batalla, Promeia obtiene 2 puntos de (Castigo de Escarcha); Al hacer que el golpe final de la (Técnica Especial: Veredicto) golpee a un enemigo en estado de Anomalía, consume 1 punto de (Castigo de Escarcha) para activar 1 vez (Abloom), calculando de forma fija el {VALOR_1} del multiplicador correspondiente; Cuando la (Abloom) propia golpea a un enemigo recupera adicionalmente 100 puntos de decibelios, en 0.5 segundos se activa como máximo una vez; cuando compañeros activan (Abloom) ella recupera 150 decibelios, se activa como máximo una vez cada 0.1 segundos; Al activar la (Técnica Definitiva: Castigo Perforahuesos) obtiene el efecto (Helada), al poseer este efecto, tras activar (Técnica Especial: Veredicto), (Ataque en Cadena: Liquidación Invertida) o (Técnica Definitiva) pulsar o mantener pulsado [Icono Especial] permite consumir el efecto (Helada) y conectar directamente con la (Técnica Especial EX: Escarcha Pesada).", tags: ["Hielo"] },
