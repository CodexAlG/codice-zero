        ...
        versions: {
            ...
            "v2.6.3": {
                ...
                skills: [
                    ...
                    { type: "Pasiva Central", name: "Pasiva Central: Amanecer", description: "La Prob. Crítica de (Ataque de Carrera: Hiten no Tsuru), (Evasión) y (Ataque de Velocidad) aumenta en un {VALOR_1}, y cuando el (Ataque de Carrera: Hiten no Tsuru - Corte) de Harumasa activa un golpe crítico contra un enemigo y activa (Ultima Técnica), obtiene 1/6 acumulaciones de (Filo Reluciente), hasta un máximo de 3 acumulaciones por uso de la habilidad y acumulándose hasta 6 veces, durando 6s; los triggers repetidos reinician la duración. Cada acumulación de (Filo Reluciente) aumenta el Daño Crítico de (Ataque de Carrera: Hiten no Tsuru - Corte) en un {VALOR_2}. Cuando (Ataque de Carrera: Hiten no Tsuru) golpea enemigo, si tiene máximas acumulaciones de (Filo Reluciente Afilado), la siguiente (Última Técnica) a lanzar automáticamente se activa: (Disparo).", tags: ["Pasiva Central"] },
