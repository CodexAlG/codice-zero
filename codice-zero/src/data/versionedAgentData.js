    ...
    50: {
        ...
        versions: {
            ...
            "v2.7.3": {
                ...
                skills: [
                    { type: "Ataque Básico", name: "Ataque Básico: Paso de Baile Meteórico", description: "Presiona [Icono Ataque]: Realiza hasta tres golpes consecutivos hacia adelante, infligiendo Daño Etéreo" },
                    { type: "Ataque Básico", name: "Ataque Cargado: Lindo Choque Volador de Mina Terrestre", description: "Mantener pulsado [Icono Ataque] para cargar, al soltar el botón en el momento adecuado, se puede lanzar un Ataque Cargado Preciso, causando Daño Etéreo, el cual aumenta el valor de Aturdimiento infligido por este movimiento en un 20%; Nangong Yu puede lanzar hasta tres etapas de Ataque Cargado, la segunda y tercera etapa de Ataque Cargado requieren consumir 50 puntos de (Contratiempo) cada una; al conectar después de (Ataque en Cadena), (Técnica Definitiva) y (Técnica Especial EX), se puede completar el Ataque Cargado Preciso más fácilmente; (Ataque en Cadena), (Técnica Definitiva) y (Técnica Especial EX) tras su activación, si el (Contratiempo) es suficiente, mantener pulsado [Icono Ataque] permite lanzar directamente la segunda y tercera etapa del Ataque Cargado, y además debe completar los pasos de precisión para acumular Ataque Cargado Preciso; (Ataque en Cadena), (Técnica Definitiva) y (Técnica Especial EX) no interrumpirán el conteo de combo de (Ataque Cargado: Lindo Choque Volador de Mina Terrestre); durante la carga de la primera etapa del ataque el nivel de resistencia a la interrupción aumenta, y el daño recibido se reduce en un 60%; durante la segunda y tercera etapa del ataque se posee un efecto de invencibilidad; la fase de embestida de la primera etapa del ataque puede bloquear ataques enemigos, si el bloqueo es exitoso este ataque también se considerará como un ataque preciso; todos los ataques poseen efecto de invencibilidad durante su ejecución." },
                    { type: "Evasión", name: "Evasión: Bailarina Nata", description: "Pulsar [Icono Dodges]: Realiza una evasión rápida; posee efecto de invencibilidad durante la ejecución del movimiento", tags: ["Etereo", "Evasión"] },
                    { type: "Evasión", name: "Ataque de Carrera: Meteoro Giratorio", description: "Al evadir, pulsar [Icono Ataque]: Realiza un ataque rápido hacia adelante, infligiendo Daño Etéreo", tags: ["Etereo", "Evasión"] },
                    { type: "Evasión", name: "Contraataque de Evasión: Vals Meteórico", description: "Tras activar una (Evasión Perfecta), pulsar [Icono Ataque]: Salta hacia adelante y realiza un ataque de barrido al aterrizar, infligiendo Daño Etéreo; posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Etereo", "Evasión"] },
                    { type: "Técnica Especial", name: "Técnica Especial: Afecto un Poco Pesado", description: "Pulsar [Icono Especial]: Blandir el martillo para lanzar un ataque, infligiendo Daño Etéreo.", tags: ["Etereo", "Técnica Especial"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Afecto Bastante Pesado", description: "Cuando la energía es suficiente, pulsar [Icono Especial EX] para activar: Blandir un martillo para lanzar un ataque, infligiendo Daño Etéreo; este movimiento no interrumpirá el conteo de combo de (Ataque Cargado: Lindo Choque Volador de Mina Terrestre); posee efecto de invencibilidad durante la ejecución del movimiento." },
                    { type: "Asistencia", name: "Asistencia Rápida: Técnica de Rescate", description: "Cuando el personaje en uso es lanzado por los aires, pulsar [Icono Assist]: Salta hacia adelante y realiza ataques consecutivos al objetivo, infligiendo Daño Etéreo; posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Etereo", "Asistencia"] },
                    { type: "Asistencia", name: "Asistencia Defensiva: Paso de Baile Perfecto", description: "Cuando el personaje en el campo está a punto de ser atacado, pulsar [Icono Assist]: Realiza un parry al ataque enemigo, acumulando una gran cantidad de valor de Aturdimiento; posee un rendimiento de parry superior, al recibir ataques de alta intensidad el consumo de (Puntos de Asistencia) se reduce; posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Etereo", "Asistencia"] },
                    { type: "Asistencia", name: "Ataque de Asistencia: Actuación Improvisada", description: "Tras activar (Asistencia Definitiva), pulsar [Icono Ataque]: Realiza ataques continuos contra el objetivo, infligiendo una gran cantidad de Daño Etéreo; posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Etereo", "Asistencia"] },
                    { type: "Pasiva Central", name: "Pasiva Central: Ídolo Genio", description: "La Maestría de Anomalía de Nangong Yu aumenta en {VALOR_1} puntos; cuando la Tasa de Anomalía de Nangong Yu es superior a 110 puntos, cada 1 punto que exceda la Tasa de Anomalía inicial aumentará su propio impacto en 1; cuando un enemigo se encuentra en estado de Aturdimiento, cualquier personaje del equipo al causar una Anomalía de Atributo o al atacar con (Abloom), acumulará para su objetivo 1 capa de (Vibrato); un mismo enemigo puede acumular hasta un máximo de 4 capas de (Vibrato); cuando el (Vibrato) se acumula hasta el número máximo de capas o cuando un enemigo que posee (Vibrato) se recupera del estado de Aturdimiento, todos los (Vibratos) serán eliminados; cuando el (Vibrato) es eliminado, Nangong Yu infligirá un ataque de (Abloom) al objetivo; calculando adicionalmente un daño de Anomalía de Atributo una vez, la proporción relativa al daño de Anomalía de Atributo original es {VALOR_2}/{VALOR_3}/{VALOR_4}/{VALOR_5}/{VALOR_6}, por cada capa de (Vibrato) que tenga el enemigo, el daño de este (Abloom) aumenta adicionalmente un 25%, durante el periodo de pérdida de Aturdimiento, si el (Vibrato) ya ha sido eliminado, el enemigo no podrá volver a recibir (Vibrato), y además al entrar en un estado de Anomalía no acumulará 1 capa de (Vibrato): cuando el (Ataque Cargado: Lindo Choque Volador de Mina Terrestre) o la (Técnica Especial EX) de Nangong Yu golpean al enemigo, Nangong Yu puede lanzar (Ataque Cargado: Volador de Mina Terrestre) o la (Asistencia Rápida: Técnica de Rescate) golpean un enemigo en estado de Anomalía de Atributo y en estado de pérdida de Aturdimiento, al golpear al enemigo con el ataque, se activará también (Abloom) en el objetivo, infligiendo al objetivo un 25% del daño del efecto de (Desorden) original, y además no eliminará el estado de Anomalía de Atributo en el que se encuentra el objetivo, y además activará (Desorden de Polaridad) en el/los personaje(s) del (Asistencia Rápida) o (Asistencia de Velocidad) del equipo; cuando Nangong Yu posee (Fiebre del Baile), el próximo cambio a la vanguardia lanzará directamente la primera etapa de (Ataque Cargado: Lindo Choque Volador de Mina Terrestre), dicho Ataque Cargado será obligatoriamente considerado como un Ataque Cargado Preciso; aumentan su propia Eficiencia de Acumulación de Anomalía en un {VALOR_7}, la Eficiencia de Aturdimiento en un {VALOR_8}, y aumentan la Eficiencia de Acumulación de Anomalía de todo el equipo en un 30%, con una duración de 20 segundos, al activarse de nuevo se reinicia la duración. El (Ataque Cargado: Lindo Choque Volador de Mina Terrestre) de Nangong Yu al lanzar un (Ataque Cargado) o un (Ataque Cargado Preciso) al golpear al enemigo, aumenta la Eficiencia de Acumulación de Anomalía propia en un 30%, causando que el valor de Aturdimiento se incremente en un 20%, con una duración de 20 segundos, al activarse de nuevo se reinicia la duración. Al estar en estado de combate, Nangong Yu recupera cada segundo 3.5 puntos de (Contratiempo), cuando cualquier personaje del equipo hace que un enemigo entre en estado de Anomalía, recuperará adicionalmente 15 puntos de (Contratiempo) para Nangong Yu, este efecto se activa como máximo una vez cada 6 segundos pero si obtiene 6 o más se recupera una vez, Nangong Yu puede poseer un máximo de 100 puntos de (Contratiempo), al recibir inicialmente 30 puntos de (Contratiempo)" },
                    { type: "Habilidad Adicional", name: "Habilidad Adicional: Capitana Ángel", description: "Se activa cuando existe un personaje de (Anomalía) o un personaje de la misma facción que ella en el equipo: La Eficiencia de Acumulación de Anomalía causada por el ataque de cualquier personaje del equipo al golpear a un enemigo en estado de Aturdimiento aumenta en un 20%, la Eficiencia de Acumulación de Anomalía causada por ataques de (Ataque en Cadena) al golpear a un enemigo en estado de Aturdimiento aumenta adicionalmente en un 40%; cuando cualquier personaje del equipo hace que un enemigo entre en estado de Aturdimiento, Nangong Yu obtiene 2 capas del efecto (Fiebre del Baile), poseyendo un máximo de 2 capas, con una duración de 15 segundos, al activarse de nuevo se reinicia la duración, al poseer (Fiebre del Baile), cuando Nangong Yu utiliza (Ataque Cargado Preciso), puede lanzar un ataque con el golpe pesado del (Ataque Cargado: Lindo Choque Volador de Mina Terrestre) o con la (Asistencia Rápida: Técnica de Rescate), al golpear al enemigo se consumirá 1 capa de (Fiebre del Baile) para activar un efecto especial de (Desorden) llamado (Desorden de Polaridad) en el objetivo, infligiendo al objetivo un 25% del daño del efecto de (Desorden) original, el (Desorden de Polaridad) no eliminará el estado de Anomalía de Atributo en el que se encuentra el objetivo, y además activará (Desorden de Polaridad) en el/los personaje(s) del (Asistencia Rápida) o (Asistencia de Velocidad) del equipo; cuando Nangong Yu posee (Fiebre del Baile), el próximo cambio a la vanguardia lanzará directamente la primera etapa de (Ataque Cargado: Lindo Choque Volador de Mina Terrestre), dicho Ataque Cargado será obligatoriamente considerado como un Ataque Cargado Preciso; cuando Nangong Yu y Aria están juntas en el equipo, al completar el (Ataque Básico: Tono Absoluto Definitivo) de Aria y golpear a un enemigo, Nangong Yu también podrá participar en este ataque, si Nangong Yu también completa la participación, también consumirá 1 capa de (Fiebre del Baile) para activar (Desorden de Polaridad) en el enemigo, este resultado no tiene limitación de estado; cuando el (Ataque Cargado: Lindo Choque Volador de Mina Terrestre) de Nangong Yu, ya sea la primera vez activando (Técnica Especial EX: Afecto Bastante Pesado), no le será posible consumir este (Extremo Caos), este resultado deberá esperar 15 segundos de enfriamiento; cuando la tercera etapa de ataque del (Ataque Cargado: Lindo Choque Volador de Mina Terrestre) de Nangong Yu golpea a un enemigo, el enemigo obtiene el efecto (Aturdir), los enemigos bajo este efecto ven aumentada su duración de Aturdimiento en 3 segundos tras entrar en estado de Aturdimiento, el multiplicador de daño de vulnerabilidad por aturdimiento aumenta un 30%, antes de recuperarse del estado de Aturdimiento el efecto (Aturdir) se activa como máximo una vez por objetivo, el efecto de aumento de duración de Aturdimiento no se puede acumular con efectos del mismo tipo, cuando termina el Aturdimiento del enemigo con efecto (Aturdir), el efecto (Aturdir) termina." },
                    { type: "Técnica Definitiva", name: "Ataque en Cadena: Gravedad de Cometa", description: "Al activar una (Ataque en Cadena), seleccionar al personaje correspondiente para lanzar: Realiza múltiples ataques hacia adelante, infligiendo una gran cantidad de Daño Etéreo; posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Etéreo", "Técnica Definitiva"] },
                    { type: "Técnica Definitiva", name: "Técnica Definitiva: Cúmulo Estelar Errante", description: "Cuando el nivel de decibelios llega a (Máximo), pulsar [Icono Definitiva]: Realiza múltiples ataques hacia adelante, infligiendo una gran cantidad de Daño Etéreo; al lanzar el movimiento, Nangong Yu despliega el (Velo Etéreo: Repetición Delirante), durante la duración del (Velo Etéreo: Repetición Delirante), el Ataque de todos los personajes del equipo aumenta adicionalmente en 50 puntos, con una duración de 30 segundos; si Nangong Yu vuelve a desplegar el (Velo Etéreo: Repetición Delirante), se cerrará el (Velo Etéreo: Repetición Delirante) existente; posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Etereo", "Técnica Definitiva"] },
                    { type: "Mindscape 1", name: "Foco Perezoso", description: "Cuando (Técnica Especial EX) o (Ataque Cargado: Lindo Choque Volador de Mina Terrestre) golpean a un enemigo, reducen la Resistencia a Todos los Atributos del enemigo en un 15%, con una duración de 40 segundos, al activarse de nuevo se reinicia la duración, al entrar al campo de batalla, el (Fiebre del Baile) de Nangong Yu se recupera hasta el valor máximo, en el Cavidad Cero este efecto se activa como máximo una vez cada 180 segundos.", tags: ["Etereo", "Mindscape 1"] },
                    { type: "Mindscape 2", name: "Lágrimas Indoloras", description: "Cada capa de (Vibrato) hace que el aumento adicional del daño de (Abloom) en la (Pasiva Central: Ídolo Genio) pase a ser del 35%; el multiplicador de daño de vulnerabilidad por aturdimiento proporcionado por la (Habilidad Adicional: Capitana Ángel) aumenta adicionalmente en un 20%; cuando el personaje en uso con un golpe de (Ataque en Cadena) golpea al enemigo que se encuentra simultáneamente en estado de Aturdimiento y en estado de Anomalía, se encontrará con un enemigo que activará (Extremo Caos), el objetivo no causará daño original con (Extremo Caos) en un 25% del daño de la herida, esta (Extremo Caos) deberá esperar 15 segundos de enfriamiento, el límite de posesión de (Fiebre del Baile) se incrementa a 3 capas." },
                    { type: "Mindscape 3", name: "Fichas en la Balanza", description: "(Ataque Básico), (Evasión), (Asistencia), (Técnica Especial) y (Ataque en Cadena) Lv. +2", tags: ["Etereo", "Mindscape 3"] },
                    { type: "Mindscape 4", name: "Paso de Baile de Cómplice", description: "La Maestría de Anomalía aumenta en 40; al activar un Ataque Cargado Preciso, la Eficiencia de Acumulación de Anomalía del (Ataque Cargado: Lindo Choque Volador de Mina Terrestre) aumenta en un 35%.", tags: ["Etereo", "Mindscape 4"] },
                    { type: "Mindscape 5", name: "Centro del Escenario", description: "(Ataque Básico), (Evasión), (Asistencia), (Técnica Especial) y (Ataque en Cadena) Lv. +2", tags: ["Etereo", "Mindscape 5"] },
                    { type: "Mindscape 6", name: "Delirio de Ángel", description: "El valor de Aturdimiento causado aumenta un 20%; cuando el enemigo no se encuentra en estado de Aturdimiento, cualquier personaje del equipo al causar una Anomalía de Atributo o (Abloom) al golpear al enemigo, cada vez que entra en un estado de Anomalía acumulará para su objetivo 1 capa de (Vibrato: Modificado); al ser golpeado relativamente por el peso del (Ataque en Cadena) o del (Ataque Cargado: Lindo Choque Volador de Mina Terrestre) acumulará 1 capa de (Vibrato: Modificado), con (Técnica Definitiva) acumulará 1 capa de (Vibrato: Modificado); (Vibrato: Modificado) se puede acumular hasta un máximo de 4 capas, cuando el enemigo entra en estado de Aturdimiento, (Vibrato: Modificado) será eliminado por completo, cuando (Vibrato: Modificado) es eliminado, Nangong Yu infligirá un ataque de (Abloom) al objetivo: calculando adicionalmente un daño de Anomalía de Atributo una vez, la proporción relativa al daño de Anomalía de Atributo original es 800%/400%/1000%/70%/100%, por cada 1 capa de (Vibrato: Modificado) que tenga el enemigo, el daño de esta (Abloom) aumenta adicionalmente en un 25%; (Vibrato: Modificado) y (Vibrato) no se pueden superponer entre sí; esta (Abloom) no tiene requisito de estado previo; cuando Nangong Yu posee (Fiebre del Baile), la próxima vez que cambie a la vanguardia lanzará directamente la primera etapa de (Ataque Cargado: Lindo Choque Volador de Mina Terrestre), dicho Ataque Cargado será obligatoriamente considerado como un Ataque Cargado Preciso.", tags: ["Etereo", "Mindscape 6"] }
                ],
                hotfixes: [
                    {
                        id: 1,
                        ...
                        skills: [
                            ...
                            { type: "Pasiva Central", name: "Pasiva Central: Ídolo Genio", description: "La Maestría de Anomalía de Nangong Yu aumenta en {VALOR_1} puntos; cuando la Tasa de Anomalía de Nangong Yu es superior a 110 puntos, cada 1 punto que exceda la Tasa de Anomalía inicial aumentará su propio impacto en 1; cuando un enemigo se encuentra en estado de Aturdimiento, cualquier personaje del equipo al causar una Anomalía de Atributo o al atacar con (Abloom), acumulará para su objetivo 1 capa de (Vibrato); un mismo enemigo puede acumular hasta un máximo de 4 capas de (Vibrato); cuando el enemigo se encuentra en estado de Anomalía de Atributo, si el (Vibrato) se acumula hasta el número máximo de capas o cuando un enemigo que posee (Vibrato) se recupera del estado de Aturdimiento, todos los (Vibratos) serán eliminados; cuando el (Vibrato) es eliminado, si el enemigo se encuentra en estado de Anomalía, Nangong Yu infligirá un ataque de (Abloom) al objetivo; calculando adicionalmente un daño de Anomalía de Atributo una vez, la proporción relativa al daño de Anomalía de Atributo original es {VALOR_2}/{VALOR_3}/{VALOR_4}/{VALOR_5}/{VALOR_6}, por cada capa de (Vibrato) que tenga el enemigo, el daño de este (Abloom) aumenta adicionalmente un 25%, durante el periodo de pérdida de Aturdimiento, si el (Vibrato) ya ha sido eliminado, el enemigo no podrá volver a recibir (Vibrato), y además al entrar en un estado de Anomalía no acumulará 1 capa de (Vibrato); cuando el (Ataque Cargado: Lindo Choque Volador de Mina Terrestre) o la (Técnica Especial EX) de Nangong Yu golpean al enemigo, aumentan su propia Eficiencia de Acumulación de Anomalía en un {VALOR_7}, la Eficiencia de Aturdimiento en un {VALOR_8}, y aumentan el daño infligido por todo el equipo en un 15%, con una duración de 20 segundos, al activarse de nuevo se reinicia la duración. El (Ataque Cargado: Lindo Choque Volador de Mina Terrestre) de Nangong Yu al lanzar un (Ataque Cargado) o un (Ataque Cargado Preciso) al golpear al enemigo, aumenta la Eficiencia de Acumulación de Anomalía propia en un 30%, causando que el valor de Aturdimiento se incremente en un 20%, con una duración de 20 segundos, al activarse de nuevo se reinicia la duración. Al estar en estado de combate, Nangong Yu recupera cada segundo 3.5 puntos de (Contratiempo), cuando cualquier personaje del equipo hace que un enemigo entre en estado de Anomalía, recuperará adicionalmente 15 puntos de (Contratiempo) para Nangong Yu, este efecto se activa como máximo una vez cada 6 segundos pero si obtiene 6 o más se recupera una vez, Nangong Yu puede poseer un máximo de 100 puntos de (Contratiempo), al recibir inicialmente 30 puntos de (Contratiempo)" },
                            { type: "Habilidad Adicional", name: "Habilidad Adicional: Capitana Ángel", description: "Se activa cuando existe un personaje de (Anomalía) o un personaje de la misma facción que ella en el equipo: La Eficiencia de Acumulación de Anomalía causada por el ataque de cualquier personaje del equipo al golpear a un enemigo en estado de Aturdimiento aumenta en un 20%, la Eficiencia de Acumulación de Anomalía causada por ataques de (Ataque en Cadena) al golpear a un enemigo en estado de Aturdimiento aumenta adicionalmente en un 40%; cuando cualquier personaje del equipo hace que un enemigo entre en estado de Aturdimiento, Nangong Yu obtiene 2 capas del efecto (Fiebre del Baile), poseyendo un máximo de 2 capas, con una duración de 15 segundos, al activarse de nuevo se reinicia la duración, al poseer (Fiebre del Baile), cuando Nangong Yu utiliza (Ataque Cargado Preciso), al cumplir todas las condiciones, puede lanzar un ataque con el golpe pesado del (Ataque Cargado: Lindo Choque Volador de Mina Terrestre) o con la (Asistencia Rápida: Técnica de Rescate), al golpear al enemigo se consumirá 1 capa de (Fiebre del Baile) para activar un efecto especial de (Desorden) llamado (Desorden de Polaridad) en el objetivo, infligiendo al objetivo un 25% del daño del efecto de (Desorden) original, el (Desorden de Polaridad) eliminará el estado de Anomalía de Atributo en el que se encuentra el objetivo, y además activará (Desorden de Polaridad) en el/los personaje(s) del (Asistencia Rápida) o (Asistencia de Velocidad) del equipo; cuando Nangong Yu posee (Fiebre del Baile), el próximo cambio a la vanguardia lanzará directamente la primera etapa de (Ataque Cargado: Lindo Choque Volador de Mina Terrestre), dicho Ataque Cargado será obligatoriamente considerado como un Ataque Cargado Preciso; cuando Nangong Yu y Aria están juntas en el equipo, al completar el (Ataque Básico: Tono Absoluto Definitivo) de Aria y golpear a un enemigo en estado de Anomalía de Atributo y Aturdimiento, Nangong Yu también podrá participar en este ataque, si Nangong Yu también completa la participación, también consumirá 1 capa de (Fiebre del Baile) para activar (Desorden de Polaridad) en el enemigo, este resultado deberá esperar 15 segundos de enfriamiento; cuando la tercera etapa de ataque del (Ataque Cargado: Lindo Choque Volador de Mina Terrestre) de Nangong Yu golpea a un enemigo, el enemigo obtiene el efecto (Aturdir), los enemigos bajo este efecto ven aumentada su duración de Aturdimiento en 3 segundos tras entrar en estado de Aturdimiento, el multiplicador de daño de vulnerabilidad por aturdimiento aumenta un 30%, antes de recuperarse del estado de Aturdimiento el efecto (Aturdir) se activa como máximo una vez por objetivo, el efecto de aumento de duración de Aturdimiento no se puede acumular con efectos del mismo tipo, cuando termina el Aturdimiento del enemigo con efecto (Aturdir), el efecto (Aturdir) termina." },
                            { type: "Mindscape 1", name: "Foco Perezoso", description: "Cuando (Técnica Especial EX: Afecto Bastante Pesado) o (Ataque Cargado: Lindo Choque Volador de Mina Terrestre) golpean a un enemigo, reducen la Resistencia a Todos los Atributos del enemigo en un 16%, con una duración de 40 segundos, al activarse de nuevo se reinicia la duración, al entrar al campo de batalla, el (Fiebre del Baile) de Nangong Yu se recupera hasta el valor máximo, en el Cavidad Cero este efecto se activa como máximo una vez cada 180 segundos.", tags: ["Etereo", "Mindscape 1"] },
                            { type: "Mindscape 2", name: "Lágrimas Indoloras", description: "Cada capa de (Vibrato) hace que el aumento adicional del daño de (Abloom) en la (Pasiva Central: Ídolo Genio) pase a ser del 35%; el multiplicador de daño de vulnerabilidad por aturdimiento proporcionado por la (Habilidad Adicional: Capitana Ángel) aumenta adicionalmente en un 20%; cuando el personaje en uso con un golpe de (Ataque en Cadena) golpea al enemigo que se encuentra simultáneamente en estado de Aturdimiento y en estado de Anomalía, se activará (Extremo Caos) en el enemigo, infligiendo al objetivo un 25% del daño del efecto de (Desorden) original, el enemigo solo puede activar este efecto una vez durante el mismo periodo de Aturdimiento, el límite de posesión de (Fiebre del Baile) se incrementa a 3 capas." },
                            { type: "Mindscape 6", name: "Delirio de Ángel", description: "Los ataques de Nangong Yu aumentan el valor de Aturdimiento causado en un 20%; cuando el enemigo no se encuentra en estado de Aturdimiento, cualquier personaje del equipo al causar una Anomalía de Atributo o (Abloom) al golpear al enemigo, cada vez que entra en un estado de Anomalía acumulará para su objetivo 1 capa de (Vibrato: Modificado); al ser golpeado por el golpe pesado del (Ataque en Cadena) o del (Ataque Cargado: Lindo Choque Volador de Mina Terrestre) acumulará 1 capa de (Vibrato: Modificado), con (Técnica Definitiva) acumulará 1 capa de (Vibrato: Modificado); (Vibrato: Modificado) se puede acumular hasta un máximo de 4 capas, cuando el enemigo entra en estado de Aturdimiento, (Vibrato: Modificado) será eliminado por completo, cuando (Vibrato: Modificado) es eliminado, Nangong Yu infligirá un ataque de (Abloom) al objetivo: calculando adicionalmente un daño de Anomalía de Atributo una vez, la proporción relativa al daño de Anomalía de Atributo original es 800%/400%/1000%/70%/100%, por cada 1 capa de (Vibrato: Modificado) que tenga el enemigo, el daño de esta (Abloom) aumenta adicionalmente en un 25%; (Vibrato: Modificado) y (Vibrato) no se pueden superponer entre sí; esta (Abloom) no tiene requisito de estado previo; cuando Nangong Yu posee (Fiebre del Baile), la próxima vez que cambie a la vanguardia lanzará directamente la primera etapa de (Ataque Cargado: Lindo Choque Volador de Mina Terrestre), dicho Ataque Cargado será obligatoriamente considerado como un Ataque Cargado Preciso.", tags: ["Etereo", "Mindscape 6"] }
                        ]
                    }
                ]
            }
        ...
        versions: {
            ...
            "v2.7.3": {
                ...
                skills: [
                    ...
                    { type: "Ataque Básico", name: "Hueso Corrosivo", description: "Inflige Daño Eléctrico a los enemigos cercanos; cada vez que se activa, aumenta su propia Probabilidad Crítica en un 6%, con una duración de 15 segundos, acumulable hasta un máximo de 3 capas, al activarse de nuevo se reinicia la duración." },
                    { type: "Evasión", name: "Evasión: Serpentear", description: "Pulsar [Icono Dodges]: Realiza una evasión rápida; posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Electrico"] },
                    { type: "Evasión", name: "Ataque de Carrera: Marca de Mordedura", description: "Al evadir, pulsar [Icono Ataque]: Realiza un ataque rápido hacia adelante, infligiendo Daño Eléctrico.", tags: ["Electrico"] },
                    { type: "Evasión", name: "Contraataque de Evasión: Devolver el Mordisco", description: "Tras activar una (Evasión Perfecta), pulsar [Icono Ataque]: Salta hacia adelante y realiza un ataque de barrido al aterrizar, infligiendo Daño Eléctrico; al golpear a un enemigo; posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Electrico"] },
                    { type: "Técnica Especial", name: "Técnica Especial: Dientes de Mono", description: "Pulsar [Icono Especial]: Lanza una mordedura de serpiente a larga distancia hacia adelante, infligiendo Daño Eléctrico; al golpear a un enemigo el nivel de resistencia a la interrupción aumenta durante la ejecución del movimiento.", tags: ["Electrico"] },
                    { type: "Técnica Especial", name: "Técnica Especial EX: Colmillo Venenoso", description: "Cuando la energía es suficiente, pulsar o mantener pulsado [Icono Especial EX]: Lanza múltiples mordeduras de serpientes a larga distancia hacia adelante, infligiendo Daño Eléctrico; al activar el movimiento, recupera 6 puntos de energía; al mantener pulsado, consumirá energía adicionalmente, cada 20 puntos activan un golpe adicional, infligiendo Daño Eléctrico, hasta consumir un máximo de 60 puntos de energía adicionales; tras mantener pulsado, obtiene 3 puntos de (Toxina), al mantener pulsado por cada 20 puntos de energía adicionales consumidos, obtiene 1 punto de (Toxina); al golpear a un enemigo; tras lanzar el movimiento, puede conectar directamente con el cuarto golpe del (Ataque Básico: Escupir Veneno); al golpear al enemigo con el movimiento, activará (Asistencia Rápida); posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Electrico"] },
                    { type: "Asistencia", name: "Asistencia Rápida: Dispositivo de Alarma", description: "Cuando el personaje en uso es lanzado por los aires, pulsar [Icono Assist]: Salta hacia adelante y realiza un ataque de barrido al aterrizar, infligiendo Daño Eléctrico; al golpear a un enemigo, posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Electrico"] },
                    { type: "Asistencia", name: "Asistencia Defensiva: Comida de Prisión", description: "Cuando el personaje en el campo está a punto de ser atacado, pulsar [Icono Assist]: Realiza un parry al ataque enemigo, acumulando una gran cantidad de valor de Aturdimiento; posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Electrico"] },
                    { type: "Asistencia", name: "Ataque de Asistencia: Amistad de Cómplice", description: "Tras activar (Asistencia Definitiva), pulsar [Icono Ataque]: Realiza ataques continuos contra el objetivo, infligiendo una gran cantidad de Daño Eléctrico; al golpear a un enemigo, posee efecto de invencibilidad durante la ejecución del movimiento.", tags: ["Electrico"] },
                ...
                hotfixes: [
                    {
                        ...
                        skills: [
                            ...
                            { type: "Mindscape 6", name: "Casa y Calle Sexta", description: "Cada vez que se activa (Hueso Corrosivo), obtiene 1 capa de (Marca de Hueso Corrosivo); cuando cualquier personaje del equipo, excepto (Hueso Corrosivo), golpea a un enemigo con un ataque, consume 1 capa de (Marca de Hueso Corrosivo), activando 1 vez un (Hueso Corrosivo) especial, este (Hueso Corrosivo) no puede causar valor de Aturdimiento, cada personaje puede consumir como máximo 1 capa de (Marca de Hueso Corrosivo) en un intervalo de 3 segundos.", tags: ["Electrico"] }
                        ]
                    }
                ]
            }
