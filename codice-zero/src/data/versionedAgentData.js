        ...
        versions: {
            ...
            "v2.7.2": {
                ...
                skills: [
                    ...
                    { type: "Técnica Especial EX", name: "Técnica Especial EX: Afecto Bastante Pesado", description: "Cuando la energía es suficiente, pulsar [Icono Especial EX] para activar: Blandir un martillo para lanzar un ataque, infligiendo Daño Etéreo; este movimiento no interrumpirá el conteo de combo de (Ataque Cargado: Lindo Choque Volador de Mina Terrestre); posee efecto de invencibilidad durante la ejecución del movimiento." },
