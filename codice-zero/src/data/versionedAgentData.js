                ...
                hotfixes: [
                    ...
                    },
                    {
                        ...
                        skills: [
                            ...
                            { type: "Técnica Especial", name: "Técnica Especial EX: Patada Voladora de Caballero", description: "Cuando el (Valor Térmico) está lleno, la energía es suficiente, y la Vida actual no es inferior al 10% de la Vida Máxima, mantener pulsado [Icono Especial] para activar: Salta de la motocicleta y patea al enemigo, infligiendo una gran cantidad de Daño Físico; Al activar el movimiento entra en (Estado de Motocicleta), al terminar el movimiento entra en (Estado Libre) y recupera Vida equivalente al 20% de su Vida Máxima; Posee efecto de invencibilidad durante la ejecución del movimiento." },
