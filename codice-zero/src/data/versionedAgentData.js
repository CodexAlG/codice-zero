...
// Mock versioned agent data for BetaDiffViewer
// Refactored to Skill-Centric structure for better diffing
    ...
    },
    {
        ...
        versions: {
            "v2.6.1": {
                ...
                description: "Al usar (Técnica Especial EX: Golpe Combinado Fotográfico) para entrar, Sunna entra en estado (Fiebre) por 5 segundos. Durante (Fiebre), los ataques de Sunna son Críticos garantizados y su Daño Crítico aumenta en un 10% de su ATK inicial, hasta un máximo de 60%; durante (Fiebre), si Sunna activa (Ataque Básico: Arañazo de Pata), se activa una marca (Hipnotizado) adicional.",
                tags: ["Mindscape"]
            },
            "v2.6.2": {
                name: "6. 'Big Bang del Hueco'",
        ...
        versions: {
            "v2.6.1": {
                ...
                coreSkillScalingColors: [
                    "text-[#d946ef]", "text-[#3b82f6]", "text-[#ef4444]", "text-[#eab308]", "text-[#22d3ee]", "text-[#d946ef]"
                ],
                coreSkillScaling: [
                    ["3.1%", "1.6%", "4%", "0.3%", "0.4%", "6.2%"],
...
export function getAgentVersionData(agentId, versionLabel) {
    ...
    const versionData = agent.versions[versionLabel];
    // We attach skills here for backward compatibility if needed,
    // but the viewer should prefer the new structure.
    // For now, let's just return the version data object.
    return versionData;
}
