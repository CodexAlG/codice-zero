  ...
  return (
    <>
      <div className="px-8 pt-8 pb-4 bg-gradient-to-t from-black/20 to-transparent">
        <h2 className="text-3xl font-bold text-yellow-400 mb-4 border-b border-gray-700 pb-2 drop-shadow-lg shadow-yellow-500/50">
        ...
        <p className="text-lg text-gray-300 max-w-4xl mb-4">
        ...
        <ul className="list-disc list-inside ml-4 text-yellow-400 max-w-4xl space-y-1">
