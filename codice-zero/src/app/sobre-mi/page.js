            ...
            <div className="max-w-7xl mx-auto relative z-10 pt-8">
                ...
                <div className="flex flex-col md:flex-row gap-8 lg:gap-12 mt-16">
                    ...
                    <div className="w-full md:w-1/3 flex flex-col gap-6">
                        <div className="bg-black/40 backdrop-blur-2xl border border-white/5 shadow-[0_20px_50px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)] rounded-3xl p-8 flex flex-col items-center text-center relative overflow-hidden group">
                    ...
                    <div className="w-full md:w-2/3 flex flex-col gap-8">
                        ...
                        <div className="bg-black/40 backdrop-blur-xl border border-white/5 rounded-3xl p-8 md:p-10 relative overflow-hidden shadow-[0_15px_40px_rgba(0,0,0,0.5)] group">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-yellow-500/5 rounded-full blur-[80px] pointer-events-none group-hover:scale-110 transition-transform duration-700"></div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-black/40 backdrop-blur-xl border border-white/5 rounded-3xl p-8 hover:-translate-y-1 hover:shadow-[0_15px_40px_rgba(0,0,0,0.5)] group relative overflow-hidden transition-all duration-500">
                        ...
                        {/* Quote Personal */}
                        <div className="bg-black/40 backdrop-blur-xl border border-white/5 border-l-[6px] border-l-yellow-500 p-8 rounded-r-3xl rounded-l-md mt-4 shadow-[0_15px_40px_rgba(0,0,0,0.5)] relative overflow-hidden">
